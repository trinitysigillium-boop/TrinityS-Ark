...
export declare class MaintenanceConfigs extends APIResource {
     ...
     * ```
     */
    update(bucketName: string, params: MaintenanceConfigUpdateParams, options?: Core.RequestOptions): Core.APIPromise<MaintenanceConfigUpdateResponse>;
    /**
     ...
     * ```
     */
    get(bucketName: string, params: MaintenanceConfigGetParams, options?: Core.RequestOptions): Core.APIPromise<MaintenanceConfigGetResponse>;
}
/**
