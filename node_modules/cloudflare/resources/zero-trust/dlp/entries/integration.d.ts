...
export declare class Integration extends APIResource {
     ...
     * ```
     */
    get(entryId: string, params: IntegrationGetParams, options?: Core.RequestOptions): Core.APIPromise<IntegrationGetResponse>;
}
...
export type IntegrationListResponse = IntegrationListResponse.UnionMember0 | IntegrationListResponse.UnionMember1 | IntegrationListResponse.UnionMember2 | IntegrationListResponse.UnionMember3 | IntegrationListResponse.UnionMember4 | IntegrationListResponse.UnionMember5 | IntegrationListResponse.UnionMember6;
...
export type IntegrationGetResponse = IntegrationGetResponse.UnionMember0 | IntegrationGetResponse.UnionMember1 | IntegrationGetResponse.UnionMember2 | IntegrationGetResponse.UnionMember3 | IntegrationGetResponse.UnionMember4 | IntegrationGetResponse.UnionMember5 | IntegrationGetResponse.UnionMember6;
export declare namespace IntegrationGetResponse {
    interface UnionMember0 {
        id: string;
        created_at: string;
        /**
