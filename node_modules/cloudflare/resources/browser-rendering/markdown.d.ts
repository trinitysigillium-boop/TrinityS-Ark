...
export declare class Markdown extends APIResource {
    /**
     ...
     * ```
     */
    create(params: MarkdownCreateParams, options?: Core.RequestOptions): Core.APIPromise<MarkdownCreateResponse>;
}
/**
 * Markdown content.
 */
...
export declare namespace Markdown {
    export { type MarkdownCreateResponse as MarkdownCreateResponse, type MarkdownCreateParams as MarkdownCreateParams, };
}
