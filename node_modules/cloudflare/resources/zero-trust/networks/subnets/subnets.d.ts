...
import { CloudflareSource, CloudflareSourceUpdateParams } from "./cloudflare-source.js";
import * as WARPAPI from "./warp.js";
import { Subnet, SubnetsV4PagePaginationArray, WARP, WARPCreateParams, WARPDeleteParams, WARPDeleteResponse, WARPEditParams, WARPGetParams } from "./warp.js";
...
export declare class Subnets extends APIResource {
     ...
     * ```
     */
    list(params: SubnetListParams, options?: Core.RequestOptions): Core.PagePromise<SubnetsV4PagePaginationArray, WARPAPI.Subnet>;
}
...
export declare namespace Subnets {
    ...
    export { WARP as WARP, type Subnet as Subnet, type WARPDeleteResponse as WARPDeleteResponse, type WARPCreateParams as WARPCreateParams, type WARPDeleteParams as WARPDeleteParams, type WARPEditParams as WARPEditParams, type WARPGetParams as WARPGetParams, };
    export { CloudflareSource as CloudflareSource, type CloudflareSourceUpdateParams as CloudflareSourceUpdateParams, };
}
