...
export declare class Roas extends APIResource {
    /**
     ...
     * ```
     */
    timeseries(query?: RoaTimeseriesParams, options?: Core.RequestOptions): Core.APIPromise<RoaTimeseriesResponse>;
...
export declare namespace RoaTimeseriesResponse {
    interface Meta {
        /**
...
export declare namespace Roas {
    export { type RoaTimeseriesResponse as RoaTimeseriesResponse, type RoaTimeseriesParams as RoaTimeseriesParams, };
}
//# sourceMappingURL=roas.d.ts.map