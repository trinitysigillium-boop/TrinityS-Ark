...
import * as WebCrawlersAPI from "./web-crawlers.js";
import { WebCrawlerSummaryParams, WebCrawlerSummaryResponse, WebCrawlerTimeseriesGroupsParams, WebCrawlerTimeseriesGroupsResponse, WebCrawlers } from "./web-crawlers.js";
export declare class Bots extends APIResource {
    webCrawlers: WebCrawlersAPI.WebCrawlers;
    /**
     ...
     * ```
     */
    summary(dimension: 'BOT' | 'BOT_KIND' | 'BOT_OPERATOR' | 'BOT_CATEGORY', query?: BotSummaryParams, options?: Core.RequestOptions): Core.APIPromise<BotSummaryResponse>;
    summary(dimension: 'BOT' | 'BOT_KIND' | 'BOT_OPERATOR' | 'BOT_CATEGORY', options?: Core.RequestOptions): Core.APIPromise<BotSummaryResponse>;
    /**
     ...
     * ```
     */
    timeseriesGroups(dimension: 'BOT' | 'BOT_KIND' | 'BOT_OPERATOR' | 'BOT_CATEGORY', query?: BotTimeseriesGroupsParams, options?: Core.RequestOptions): Core.APIPromise<BotTimeseriesGroupsResponse>;
    timeseriesGroups(dimension: 'BOT' | 'BOT_KIND' | 'BOT_OPERATOR' | 'BOT_CATEGORY', options?: Core.RequestOptions): Core.APIPromise<BotTimeseriesGroupsResponse>;
}
export interface BotListResponse {
    bots: Array<BotListResponse.Bot>;
}
export declare namespace BotListResponse {
    interface Bot {
        /**
...
export declare namespace BotGetResponse {
    interface Bot {
        /**
         * The category of the bot.
         */
...
export declare namespace BotSummaryResponse {
    /**
     * Metadata for the results.
     */
    interface Meta {
