...
export declare class Items extends APIResource {
     ...
     * ```
     */
    list(name: string, id: string, params: ItemListParams, options?: Core.RequestOptions): Core.PagePromise<ItemListResponsesV4PagePaginationArray, ItemListResponse>;
    /**
     ...
     * ```
     */
    delete(name: string, id: string, itemId: string, params: ItemDeleteParams, options?: Core.RequestOptions): Core.APIPromise<ItemDeleteResponse>;
    /**
     ...
     * ```
     */
    chunks(name: string, id: string, itemId: string, params: ItemChunksParams, options?: Core.RequestOptions): Core.APIPromise<ItemChunksResponse>;
    /**
     ...
     * ```
     */
    createOrUpdate(name: string, id: string, params: ItemCreateOrUpdateParams, options?: Core.RequestOptions): Core.APIPromise<ItemCreateOrUpdateResponse>;
    /**
     ...
     * ```
     */
    download(name: string, id: string, itemId: string, params: ItemDownloadParams, options?: Core.RequestOptions): Core.APIPromise<Response>;
    /**
     ...
     * ```
     */
    get(name: string, id: string, itemId: string, params: ItemGetParams, options?: Core.RequestOptions): Core.APIPromise<ItemGetResponse>;
    /**
     ...
     * ```
     */
    logs(name: string, id: string, itemId: string, params: ItemLogsParams, options?: Core.RequestOptions): Core.APIPromise<ItemLogsResponse>;
    /**
     ...
     * ```
     */
    sync(name: string, id: string, itemId: string, params: ItemSyncParams, options?: Core.RequestOptions): Core.APIPromise<ItemSyncResponse>;
    /**
     ...
     * ```
     */
    upload(name: string, id: string, params: ItemUploadParams, options?: Core.RequestOptions): Core.APIPromise<ItemUploadResponse>;
}
export declare class ItemListResponsesV4PagePaginationArray extends V4PagePaginationArray<ItemListResponse> {
}
...
export declare namespace ItemChunksResponse {
    ...
    namespace ItemChunksResponseItem {
        interface Item {
            key: string;
            metadata?: {
                [key: string]: unknown;
...
export declare namespace ItemLogsResponse {
...
export declare namespace ItemUploadParams {
    interface File {
        /**
