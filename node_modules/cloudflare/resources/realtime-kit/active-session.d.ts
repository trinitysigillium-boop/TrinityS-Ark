...
export declare class ActiveSession extends APIResource {
    /**
     ...
     * ```
     */
    createPoll(appId: string, meetingId: string, params: ActiveSessionCreatePollParams, options?: Core.RequestOptions): Core.APIPromise<ActiveSessionCreatePollResponse>;
    /**
     ...
     * ```
     */
    getActiveSession(appId: string, meetingId: string, params: ActiveSessionGetActiveSessionParams, options?: Core.RequestOptions): Core.APIPromise<ActiveSessionGetActiveSessionResponse>;
    /**
     ...
     * ```
     */
    kickAllParticipants(appId: string, meetingId: string, params: ActiveSessionKickAllParticipantsParams, options?: Core.RequestOptions): Core.APIPromise<ActiveSessionKickAllParticipantsResponse>;
    /**
     ...
     * ```
     */
    kickParticipants(appId: string, meetingId: string, params: ActiveSessionKickParticipantsParams, options?: Core.RequestOptions): Core.APIPromise<ActiveSessionKickParticipantsResponse>;
}
export interface ActiveSessionCreatePollResponse {
    data?: ActiveSessionCreatePollResponse.Data;
    success?: boolean;
}
export declare namespace ActiveSessionCreatePollResponse {
    interface Data {
        action?: string;
        poll?: Data.Poll;
    }
...
export declare namespace ActiveSessionGetActiveSessionResponse {
    interface Data {
        /**
         * ID of the session
         */
...
export declare namespace ActiveSessionKickAllParticipantsResponse {
    interface Data {
        action?: string;
...
export declare namespace ActiveSessionKickParticipantsResponse {
    interface Data {
        action?: string;
...
export declare namespace ActiveSession {
    export { type ActiveSessionCreatePollResponse as ActiveSessionCreatePollResponse, type ActiveSessionGetActiveSessionResponse as ActiveSessionGetActiveSessionResponse, type ActiveSessionKickAllParticipantsResponse as ActiveSessionKickAllParticipantsResponse, type ActiveSessionKickParticipantsResponse as ActiveSessionKickParticipantsResponse, type ActiveSessionCreatePollParams as ActiveSessionCreatePollParams, type ActiveSessionGetActiveSessionParams as ActiveSessionGetActiveSessionParams, type ActiveSessionKickAllParticipantsParams as ActiveSessionKickAllParticipantsParams, type ActiveSessionKickParticipantsParams as ActiveSessionKickParticipantsParams, };
}
