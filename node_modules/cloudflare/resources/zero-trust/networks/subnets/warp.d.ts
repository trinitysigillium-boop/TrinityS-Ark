...
export declare class WARP extends APIResource {
    /**
     ...
     * ```
     */
    delete(subnetId: string, params: WARPDeleteParams, options?: Core.RequestOptions): Core.APIPromise<WARPDeleteResponse | null>;
    /**
...
export declare class SubnetsV4PagePaginationArray extends V4PagePaginationArray<Subnet> {
}
...
export declare namespace WARP {
    export { type Subnet as Subnet, type WARPDeleteResponse as WARPDeleteResponse, type WARPCreateParams as WARPCreateParams, type WARPDeleteParams as WARPDeleteParams, type WARPEditParams as WARPEditParams, type WARPGetParams as WARPGetParams, };
}
