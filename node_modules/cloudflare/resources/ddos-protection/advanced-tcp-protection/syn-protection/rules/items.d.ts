...
export declare class Items extends APIResource {
     ...
     * ```
     */
    delete(ruleId: string, params: ItemDeleteParams, options?: Core.RequestOptions): Core.APIPromise<ItemDeleteResponse>;
    /**
     ...
     * ```
     */
    edit(ruleId: string, params: ItemEditParams, options?: Core.RequestOptions): Core.APIPromise<ItemEditResponse>;
    /**
     ...
     * ```
     */
    get(ruleId: string, params: ItemGetParams, options?: Core.RequestOptions): Core.APIPromise<ItemGetResponse>;
}
