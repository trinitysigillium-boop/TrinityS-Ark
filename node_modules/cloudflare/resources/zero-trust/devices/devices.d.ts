...
import * as DeploymentGroupsAPI from "./deployment-groups.js";
import { DeploymentGroup, DeploymentGroupCreateParams, DeploymentGroupDeleteParams, DeploymentGroupDeleteResponse, DeploymentGroupEditParams, DeploymentGroupGetParams, DeploymentGroupListParams, DeploymentGroups, DeploymentGroupsV4PagePaginationArray } from "./deployment-groups.js";
...
import { DEXTestCreateParams, DEXTestCreateResponse, DEXTestDeleteParams, DEXTestDeleteResponse, DEXTestGetParams, DEXTestGetResponse, DEXTestListParams, DEXTestListResponse, DEXTestListResponsesV4PagePaginationArray, DEXTestUpdateParams, DEXTestUpdateResponse, DEXTests, SchemaData, SchemaHTTP } from "./dex-tests.js";
...
import * as IPProfilesAPI from "./ip-profiles.js";
import { IPProfile, IPProfileCreateParams, IPProfileDeleteParams, IPProfileDeleteResponse, IPProfileGetParams, IPProfileListParams, IPProfileUpdateParams, IPProfiles, IPProfilesSinglePage } from "./ip-profiles.js";
...
export declare class Devices extends APIResource {
    ...
    ipProfiles: IPProfilesAPI.IPProfiles;
    deploymentGroups: DeploymentGroupsAPI.DeploymentGroups;
...
export declare namespace Devices {
    ...
    export { DEXTests as DEXTests, type SchemaData as SchemaData, type SchemaHTTP as SchemaHTTP, type DEXTestCreateResponse as DEXTestCreateResponse, type DEXTestUpdateResponse as DEXTestUpdateResponse, type DEXTestListResponse as DEXTestListResponse, type DEXTestDeleteResponse as DEXTestDeleteResponse, type DEXTestGetResponse as DEXTestGetResponse, DEXTestListResponsesV4PagePaginationArray as DEXTestListResponsesV4PagePaginationArray, type DEXTestCreateParams as DEXTestCreateParams, type DEXTestUpdateParams as DEXTestUpdateParams, type DEXTestListParams as DEXTestListParams, type DEXTestDeleteParams as DEXTestDeleteParams, type DEXTestGetParams as DEXTestGetParams, };
    export { IPProfiles as IPProfiles, type IPProfile as IPProfile, type IPProfileDeleteResponse as IPProfileDeleteResponse, IPProfilesSinglePage as IPProfilesSinglePage, type IPProfileCreateParams as IPProfileCreateParams, type IPProfileUpdateParams as IPProfileUpdateParams, type IPProfileListParams as IPProfileListParams, type IPProfileDeleteParams as IPProfileDeleteParams, type IPProfileGetParams as IPProfileGetParams, };
    export { DeploymentGroups as DeploymentGroups, type DeploymentGroup as DeploymentGroup, type DeploymentGroupDeleteResponse as DeploymentGroupDeleteResponse, DeploymentGroupsV4PagePaginationArray as DeploymentGroupsV4PagePaginationArray, type DeploymentGroupCreateParams as DeploymentGroupCreateParams, type DeploymentGroupListParams as DeploymentGroupListParams, type DeploymentGroupDeleteParams as DeploymentGroupDeleteParams, type DeploymentGroupEditParams as DeploymentGroupEditParams, type DeploymentGroupGetParams as DeploymentGroupGetParams, };
