...
export declare namespace RewriteRule {
    ...
    interface ActionParameters {
         ...
         */
        headers?: {
            [key: string]: ActionParameters.AddStaticHeader | ActionParameters.AddDynamicHeader | ActionParameters.SetStaticHeader | ActionParameters.SetDynamicHeader | ActionParameters.RemoveHeader;
        };
        /**
         * A URI path rewrite.
         */
...
export interface RuleCreateResponse {
     ...
     */
    rules: Array<BlockRule | RuleCreateResponse.RulesetsChallengeRule | CompressResponseRule | DDoSDynamicRule | ExecuteRule | ForceConnectionCloseRule | RuleCreateResponse.RulesetsJSChallengeRule | LogRule | LogCustomFieldRule | ManagedChallengeRule | RedirectRule | RewriteRule | RouteRule | ScoreRule | ServeErrorRule | RuleCreateResponse.RulesetsSetCacheControlRule | SetCacheSettingsRule | RuleCreateResponse.RulesetsSetCacheTagsRule | SetConfigRule | SkipRule>;
    /**
...
export declare namespace RuleCreateResponse {
    ...
    namespace RulesetsSetCacheControlRule {
        /**
         * The parameters configuring the rule's action.
         */
        interface ActionParameters {
    ...
    interface RulesetsSetCacheTagsRule {
         ...
         * The parameters configuring the rule's action.
         */
        action_parameters?: RulesetsSetCacheTagsRule.AddCacheTagsValues | RulesetsSetCacheTagsRule.AddCacheTagsExpression | RulesetsSetCacheTagsRule.RemoveCacheTagsValues | RulesetsSetCacheTagsRule.RemoveCacheTagsExpression | RulesetsSetCacheTagsRule.SetCacheTagsValues | RulesetsSetCacheTagsRule.SetCacheTagsExpression;
        /**
         * The categories of the rule.
         */
        categories?: Array<string>;
    ...
    namespace RulesetsSetCacheTagsRule {
        /**
         ...
         */
        interface RemoveCacheTagsValues {
            /**
             * The operation to perform on the cache tags.
             */
            operation: 'add' | 'remove' | 'set';
         ...
         */
        interface RemoveCacheTagsExpression {
            /**
             * An expression that evaluates to an array of cache tag values.
             */
            expression: string;
         ...
         */
        interface SetCacheTagsExpression {
            /**
             * An expression that evaluates to an array of cache tag values.
             */
            expression: string;
...
export interface RuleDeleteResponse {
     ...
     * The list of rules in the ruleset.
     */
    rules: Array<BlockRule | RuleDeleteResponse.RulesetsChallengeRule | CompressResponseRule | DDoSDynamicRule | ExecuteRule | ForceConnectionCloseRule | RuleDeleteResponse.RulesetsJSChallengeRule | LogRule | LogCustomFieldRule | ManagedChallengeRule | RedirectRule | RewriteRule | RouteRule | ScoreRule | ServeErrorRule | RuleDeleteResponse.RulesetsSetCacheControlRule | SetCacheSettingsRule | RuleDeleteResponse.RulesetsSetCacheTagsRule | SetConfigRule | SkipRule>;
    /**
     * The version of the ruleset.
     */
    version: string;
...
export interface RuleEditResponse {
     ...
     * The list of rules in the ruleset.
     */
    rules: Array<BlockRule | RuleEditResponse.RulesetsChallengeRule | CompressResponseRule | DDoSDynamicRule | ExecuteRule | ForceConnectionCloseRule | RuleEditResponse.RulesetsJSChallengeRule | LogRule | LogCustomFieldRule | ManagedChallengeRule | RedirectRule | RewriteRule | RouteRule | ScoreRule | ServeErrorRule | RuleEditResponse.RulesetsSetCacheControlRule | SetCacheSettingsRule | RuleEditResponse.RulesetsSetCacheTagsRule | SetConfigRule | SkipRule>;
    /**
     * The version of the ruleset.
     */
    version: string;
...
export type RuleCreateParams = RuleCreateParams.BlockRule | RuleCreateParams.ChallengeRule | RuleCreateParams.ResponseCompressionRule | RuleCreateParams.DDoSDynamicRule | RuleCreateParams.ExecuteRule | RuleCreateParams.ForceConnectionCloseRule | RuleCreateParams.JavaScriptChallengeRule | RuleCreateParams.LogRule | RuleCreateParams.LogCustomFieldRule | RuleCreateParams.ManagedChallengeRule | RuleCreateParams.RedirectRule | RuleCreateParams.RewriteRule | RuleCreateParams.RouteRule | RuleCreateParams.ScoreRule | RuleCreateParams.ServeErrorRule | RuleCreateParams.SetCacheControlRule | RuleCreateParams.SetCacheSettingsRule | RuleCreateParams.SetCacheTagsRule | RuleCreateParams.SetConfigurationRule | RuleCreateParams.SkipRule;
export declare namespace RuleCreateParams {
    ...
    interface ResponseCompressionRule {
        /**
         * Path param: The Account ID to use for this endpoint. Mutually exclusive with the
         * Zone ID.
         */
         ...
         * Body param: An object configuring where the rule will be placed.
         */
        position?: ResponseCompressionRule.BeforePosition | ResponseCompressionRule.AfterPosition | ResponseCompressionRule.IndexPosition;
        /**
         * Body param: An object configuring the rule's rate limit behavior.
         */
    ...
    namespace ResponseCompressionRule {
        /**
         * The parameters configuring the rule's action.
         */
        interface ActionParameters {
    ...
    interface ForceConnectionCloseRule {
         ...
         * Body param: An object configuring where the rule will be placed.
         */
        position?: ForceConnectionCloseRule.BeforePosition | ForceConnectionCloseRule.AfterPosition | ForceConnectionCloseRule.IndexPosition;
        /**
         * Body param: An object configuring the rule's rate limit behavior.
         */
        ratelimit?: ForceConnectionCloseRule.Ratelimit;
    ...
    interface JavaScriptChallengeRule {
         ...
         * Body param: An object configuring where the rule will be placed.
         */
        position?: JavaScriptChallengeRule.BeforePosition | JavaScriptChallengeRule.AfterPosition | JavaScriptChallengeRule.IndexPosition;
        /**
         * Body param: An object configuring the rule's rate limit behavior.
         */
    ...
    interface LogCustomFieldRule {
         ...
         * Body param: An object configuring where the rule will be placed.
         */
        position?: LogCustomFieldRule.BeforePosition | LogCustomFieldRule.AfterPosition | LogCustomFieldRule.IndexPosition;
        /**
         * Body param: An object configuring the rule's rate limit behavior.
         */
        ratelimit?: LogCustomFieldRule.Ratelimit;
    ...
    interface ManagedChallengeRule {
         ...
         * Body param: An object configuring where the rule will be placed.
         */
        position?: ManagedChallengeRule.BeforePosition | ManagedChallengeRule.AfterPosition | ManagedChallengeRule.IndexPosition;
        /**
         * Body param: An object configuring the rule's rate limit behavior.
         */
        ratelimit?: ManagedChallengeRule.Ratelimit;
    ...
    interface SetCacheControlRule {
         ...
         * Body param: An object configuring where the rule will be placed.
         */
        position?: SetCacheControlRule.BeforePosition | SetCacheControlRule.AfterPosition | SetCacheControlRule.IndexPosition;
        /**
         * Body param: An object configuring the rule's rate limit behavior.
         */
    ...
    interface SetCacheSettingsRule {
         ...
         * Body param: An object configuring where the rule will be placed.
         */
        position?: SetCacheSettingsRule.BeforePosition | SetCacheSettingsRule.AfterPosition | SetCacheSettingsRule.IndexPosition;
        /**
         * Body param: An object configuring the rule's rate limit behavior.
         */
        ratelimit?: SetCacheSettingsRule.Ratelimit;
    ...
    interface SetCacheTagsRule {
         ...
         * Body param: The parameters configuring the rule's action.
         */
        action_parameters?: SetCacheTagsRule.AddCacheTagsValues | SetCacheTagsRule.AddCacheTagsExpression | SetCacheTagsRule.RemoveCacheTagsValues | SetCacheTagsRule.RemoveCacheTagsExpression | SetCacheTagsRule.SetCacheTagsValues | SetCacheTagsRule.SetCacheTagsExpression;
        /**
         * Body param: An informative description of the rule.
         */
        description?: string;
         ...
         * Body param: An object configuring where the rule will be placed.
         */
        position?: SetCacheTagsRule.BeforePosition | SetCacheTagsRule.AfterPosition | SetCacheTagsRule.IndexPosition;
        /**
         * Body param: An object configuring the rule's rate limit behavior.
         */
    ...
    interface SetConfigurationRule {
        /**
         * Path param: The Account ID to use for this endpoint. Mutually exclusive with the
         * Zone ID.
         */
         ...
         * Body param: An object configuring where the rule will be placed.
         */
        position?: SetConfigurationRule.BeforePosition | SetConfigurationRule.AfterPosition | SetConfigurationRule.IndexPosition;
        /**
         * Body param: An object configuring the rule's rate limit behavior.
         */
    ...
    namespace SetConfigurationRule {
        /**
         * The parameters configuring the rule's action.
         */
        interface ActionParameters {
...
export type RuleEditParams = RuleEditParams.BlockRule | RuleEditParams.ChallengeRule | RuleEditParams.ResponseCompressionRule | RuleEditParams.DDoSDynamicRule | RuleEditParams.ExecuteRule | RuleEditParams.ForceConnectionCloseRule | RuleEditParams.JavaScriptChallengeRule | RuleEditParams.LogRule | RuleEditParams.LogCustomFieldRule | RuleEditParams.ManagedChallengeRule | RuleEditParams.RedirectRule | RuleEditParams.RewriteRule | RuleEditParams.RouteRule | RuleEditParams.ScoreRule | RuleEditParams.ServeErrorRule | RuleEditParams.SetCacheControlRule | RuleEditParams.SetCacheSettingsRule | RuleEditParams.SetCacheTagsRule | RuleEditParams.SetConfigurationRule | RuleEditParams.SkipRule;
