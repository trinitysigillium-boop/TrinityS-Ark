...
export declare class Entries extends APIResource {
     ...
     * ```
     */
    create(datasetId: string, version: number, entryId: string, datasetVersionEntry: string | ArrayBufferView | ArrayBuffer | BlobLike, params: EntryCreateParams, options?: Core.RequestOptions): Core.APIPromise<EntryCreateResponse>;
}
