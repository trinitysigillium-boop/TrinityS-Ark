...
export declare class MaintenanceConfigs extends APIResource {
    /**
     ...
     * ```
     */
    update(bucketName: string, namespace: string, tableName: string, params: MaintenanceConfigUpdateParams, options?: Core.RequestOptions): Core.APIPromise<MaintenanceConfigUpdateResponse>;
    /**
     ...
     * ```
     */
    get(bucketName: string, namespace: string, tableName: string, params: MaintenanceConfigGetParams, options?: Core.RequestOptions): Core.APIPromise<MaintenanceConfigGetResponse>;
}
/**
...
export declare namespace MaintenanceConfigUpdateResponse {
    /**
     * Configures compaction settings for table optimization.
     */
...
export declare namespace MaintenanceConfigGetResponse {
    /**
     * Configures maintenance for the table.
     */
...
export declare namespace MaintenanceConfigUpdateParams {
    /**
...
export declare namespace MaintenanceConfigs {
    export { type MaintenanceConfigUpdateResponse as MaintenanceConfigUpdateResponse, type MaintenanceConfigGetResponse as MaintenanceConfigGetResponse, type MaintenanceConfigUpdateParams as MaintenanceConfigUpdateParams, type MaintenanceConfigGetParams as MaintenanceConfigGetParams, };
}
