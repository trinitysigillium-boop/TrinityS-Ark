...
export declare class ZoneTags extends APIResource {
    /**
 ...
 */
export type ZoneTagUpdateResponse = ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectAccessApplication | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectAccessApplicationPolicy | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectAccessGroup | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectAccount | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectAIGateway | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectAlertingPolicy | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectAlertingWebhook | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectAPIGatewayOperation | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectCloudflaredTunnel | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectCustomCertificate | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectCustomHostname | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectD1Database | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectDNSRecord | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectDurableObjectNamespace | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectGatewayList | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectGatewayRule | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectImage | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectKVNamespace | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectManagedClientCertificate | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectQueue | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectR2Bucket | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectResourceShare | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectStreamLiveInput | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectStreamVideo | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectWorker | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectWorkerVersion | ZoneTagUpdateResponse.ResourceTaggingTaggedResourceObjectZone;
export declare namespace ZoneTagUpdateResponse {
    /**
     * Response for access_application resources
     */
 ...
 * Response for access_application resources
 */
export type ZoneTagGetResponse = ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectAccessApplication | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectAccessApplicationPolicy | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectAccessGroup | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectAccount | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectAIGateway | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectAlertingPolicy | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectAlertingWebhook | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectAPIGatewayOperation | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectCloudflaredTunnel | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectCustomCertificate | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectCustomHostname | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectD1Database | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectDNSRecord | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectDurableObjectNamespace | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectGatewayList | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectGatewayRule | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectImage | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectKVNamespace | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectManagedClientCertificate | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectQueue | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectR2Bucket | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectResourceShare | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectStreamLiveInput | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectStreamVideo | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectWorker | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectWorkerVersion | ZoneTagGetResponse.ResourceTaggingTaggedResourceObjectZone;
export declare namespace ZoneTagGetResponse {
    /**
     * Response for access_application resources
     */
    interface ResourceTaggingTaggedResourceObjectAccessApplication {
...
export type ZoneTagUpdateParams = ZoneTagUpdateParams.ResourceTaggingSetTagsRequestZoneLevelBase | ZoneTagUpdateParams.ResourceTaggingSetTagsRequestZoneLevelAccessApplicationPolicy;
export declare namespace ZoneTagUpdateParams {
    interface ResourceTaggingSetTagsRequestZoneLevelBase {
        /**
         ...
         * required fields).
         */
        resource_type: 'api_gateway_operation' | 'custom_certificate' | 'custom_hostname' | 'dns_record' | 'managed_client_certificate' | 'zone';
        /**
    ...
    interface ResourceTaggingSetTagsRequestZoneLevelAccessApplicationPolicy {
        /**
         * Path param: Zone ID is required only for zone-level resources
         */
        zone_id: string;
         ...
         * required fields).
         */
        resource_type: 'api_gateway_operation' | 'custom_certificate' | 'custom_hostname' | 'dns_record' | 'managed_client_certificate' | 'zone' | 'access_application_policy';
        /**
         * Body param: Contains key-value pairs of tags.
         */
        tags?: {
...
export interface ZoneTagGetParams {
     ...
     */
    resource_type: 'access_application_policy' | 'api_gateway_operation' | 'custom_certificate' | 'custom_hostname' | 'dns_record' | 'managed_client_certificate' | 'zone';
    /**
...
export declare namespace ZoneTags {
    export { type ZoneTagUpdateResponse as ZoneTagUpdateResponse, type ZoneTagGetResponse as ZoneTagGetResponse, type ZoneTagUpdateParams as ZoneTagUpdateParams, type ZoneTagDeleteParams as ZoneTagDeleteParams, type ZoneTagGetParams as ZoneTagGetParams, };
}
//# sourceMappingURL=zone-tags.d.ts.map