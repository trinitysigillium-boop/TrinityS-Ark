...
class Queues extends resource_1.APIResource {
     ...
     * ```
     */
    getMetrics(queueId, params, options) {
        const { account_id } = params;
        return this._client.get(`/accounts/${account_id}/queues/${queueId}/metrics`, options)._thenUnwrap((obj) => obj.result);
    }
}
...
Queues.Subscriptions = subscriptions_1.Subscriptions;
Queues.SubscriptionListResponsesV4PagePaginationArray = subscriptions_1.SubscriptionListResponsesV4PagePaginationArray;
