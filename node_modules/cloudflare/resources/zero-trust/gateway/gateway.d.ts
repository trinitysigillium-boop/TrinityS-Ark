...
import * as PacfilesAPI from "./pacfiles.js";
import { PacfileCreateParams, PacfileCreateResponse, PacfileDeleteParams, PacfileDeleteResponse, PacfileGetParams, PacfileGetResponse, PacfileListParams, PacfileListResponse, PacfileListResponsesSinglePage, PacfileUpdateParams, PacfileUpdateResponse, Pacfiles } from "./pacfiles.js";
...
import { DNSResolverSettingsV4, DNSResolverSettingsV6, GatewayFilter, GatewayRule, GatewayRulesSinglePage, RuleCreateParams, RuleDeleteParams, RuleDeleteResponse, RuleGetParams, RuleListParams, RuleListTenantParams, RuleResetExpirationParams, RuleSetting, RuleUpdateParams, Rules, Schedule } from "./rules.js";
...
export declare namespace Gateway {
    ...
    export { Pacfiles as Pacfiles, type PacfileCreateResponse as PacfileCreateResponse, type PacfileUpdateResponse as PacfileUpdateResponse, type PacfileListResponse as PacfileListResponse, type PacfileDeleteResponse as PacfileDeleteResponse, type PacfileGetResponse as PacfileGetResponse, PacfileListResponsesSinglePage as PacfileListResponsesSinglePage, type PacfileCreateParams as PacfileCreateParams, type PacfileUpdateParams as PacfileUpdateParams, type PacfileListParams as PacfileListParams, type PacfileDeleteParams as PacfileDeleteParams, type PacfileGetParams as PacfileGetParams, };
}
