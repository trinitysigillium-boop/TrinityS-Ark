...
class AS112 extends resource_1.APIResource {
    constructor() {
        super(...arguments);
    ...
    summaryV2(dimension, query = {}, options) {
        ...
        return this._client.get(`/radar/as112/summary/${dimension}`, { query, ...options })._thenUnwrap((obj) => obj.result);
    }
    ...
    timeseriesGroupsV2(dimension, query = {}, options) {
        ...
        return this._client.get(`/radar/as112/timeseries_groups/${dimension}`, {
            query,
            ...options,
...
exports.AS112 = AS112;
AS112.Summary = summary_1.Summary;
AS112.TimeseriesGroups = timeseries_groups_1.TimeseriesGroups;
AS112.Top = top_1.Top;
//# sourceMappingURL=as112.js.map