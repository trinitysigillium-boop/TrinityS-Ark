...
import { ItemDeleteParams, ItemDeleteResponse, ItemEditParams, ItemEditResponse, ItemGetParams, ItemGetResponse, Items } from "./items.js";
...
export declare class Filters extends APIResource {
     ...
     * ```
     */
    list(params: FilterListParams, options?: Core.RequestOptions): Core.PagePromise<FilterListResponsesV4PagePaginationArray, FilterListResponse>;
    /**
     ...
     * ```
     */
    bulkDelete(params: FilterBulkDeleteParams, options?: Core.RequestOptions): Core.APIPromise<FilterBulkDeleteResponse>;
}
export declare class FilterListResponsesV4PagePaginationArray extends V4PagePaginationArray<FilterListResponse> {
}
...
export declare namespace FilterBulkDeleteResponse {
    interface Error {
        code: number;
        message: string;
...
export declare namespace Filters {
    export { type FilterCreateResponse as FilterCreateResponse, type FilterListResponse as FilterListResponse, type FilterBulkDeleteResponse as FilterBulkDeleteResponse, FilterListResponsesV4PagePaginationArray as FilterListResponsesV4PagePaginationArray, type FilterCreateParams as FilterCreateParams, type FilterListParams as FilterListParams, type FilterBulkDeleteParams as FilterBulkDeleteParams, };
    export { Items as Items, type ItemDeleteResponse as ItemDeleteResponse, type ItemEditResponse as ItemEditResponse, type ItemGetResponse as ItemGetResponse, type ItemDeleteParams as ItemDeleteParams, type ItemEditParams as ItemEditParams, type ItemGetParams as ItemGetParams, };
}
