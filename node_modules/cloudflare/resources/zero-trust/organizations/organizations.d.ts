...
import * as DOHAPI from "./doh.js";
import { DOH, DOHGetParams, DOHGetResponse, DOHUpdateParams, DOHUpdateResponse } from "./doh.js";
...
export declare namespace Organization {
     ...
     * Configures SSH PIV key requirements for MFA using hardware security keys.
     */
    interface MfaSSHPivKeyRequirements {
        /**
...
export declare namespace OrganizationCreateParams {
    /**
     * Configures multi-factor authentication (MFA) settings for an organization.
     */
    interface MfaConfig {
