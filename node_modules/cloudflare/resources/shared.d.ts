...
export declare namespace ErrorData {
    interface Source {
        pointer?: string;
    }
}
...
export interface RatePlan {
     ...
     */
    id?: 'free' | 'lite' | 'pro' | 'pro_plus' | 'business' | 'enterprise' | 'partners_free' | 'partners_pro' | 'partners_business' | 'partners_enterprise';
    /**
...
export declare namespace ResponseInfo {
    interface Source {
        pointer?: string;
    }
}
...
export declare class RolesV4PagePaginationArray extends V4PagePaginationArray<Role> {
}
...
export declare class CloudflareTunnelsV4PagePaginationArray extends V4PagePaginationArray<CloudflareTunnel> {
}
