...
export declare class OriginCloudRegions extends APIResource {
    /**
     ...
     * ```
     */
    create(params: OriginCloudRegionCreateParams, options?: Core.RequestOptions): Core.APIPromise<OriginCloudRegionCreateResponse>;
    /**
     ...
     * ```
     */
    list(params: OriginCloudRegionListParams, options?: Core.RequestOptions): Core.APIPromise<OriginCloudRegionListResponse>;
    /**
     ...
     * ```
     */
    delete(originIP: string, params: OriginCloudRegionDeleteParams, options?: Core.RequestOptions): Core.APIPromise<OriginCloudRegionDeleteResponse>;
    /**
     ...
     * ```
     */
    bulkDelete(params: OriginCloudRegionBulkDeleteParams, options?: Core.RequestOptions): Core.APIPromise<OriginCloudRegionBulkDeleteResponse>;
    /**
     ...
     * ```
     */
    bulkEdit(params: OriginCloudRegionBulkEditParams, options?: Core.RequestOptions): Core.APIPromise<OriginCloudRegionBulkEditResponse>;
    /**
     ...
     * ```
     */
    edit(params: OriginCloudRegionEditParams, options?: Core.RequestOptions): Core.APIPromise<OriginCloudRegionEditResponse>;
    /**
     ...
     * ```
     */
    get(originIP: string, params: OriginCloudRegionGetParams, options?: Core.RequestOptions): Core.APIPromise<OriginCloudRegionGetResponse>;
    /**
     ...
     * ```
     */
    supportedRegions(params: OriginCloudRegionSupportedRegionsParams, options?: Core.RequestOptions): Core.APIPromise<OriginCloudRegionSupportedRegionsResponse>;
}
/**
...
export declare namespace OriginCloudRegionBulkDeleteResponse {
    interface Value {
        /**
...
export declare namespace OriginCloudRegionBulkEditResponse {
    interface Value {
        /**
         * Items that could not be applied, with error details.
         */
...
export interface OriginCloudRegionSupportedRegionsResponse {
     ...
     */
    vendors: {
        [key: string]: Array<OriginCloudRegionSupportedRegionsResponse.Vendor>;
    };
}
export declare namespace OriginCloudRegionSupportedRegionsResponse {
    /**
...
export declare namespace OriginCloudRegionBulkEditParams {
    /**
