...
export declare class CNIs extends APIResource {
    /**
     ...
     * ```
     */
    update(cni: string, params: CNIUpdateParams, options?: Core.RequestOptions): Core.APIPromise<CNIUpdateResponse>;
    /**
...
export declare namespace CNICreateResponse {
    interface Magic {
        conduit_name: string;
        description: string;
        mtu: number;
...
export declare namespace CNIUpdateResponse {
    interface Magic {
        conduit_name: string;
        description: string;
        mtu: number;
...
export declare namespace CNIListResponse {
    interface Item {
        id: string;
        /**
         * Customer account tag
...
export declare namespace CNIGetResponse {
    interface Magic {
        conduit_name: string;
        description: string;
        mtu: number;
...
export declare namespace CNICreateParams {
    interface Magic {
        conduit_name: string;
        description: string;
        mtu: number;
...
export declare namespace CNIUpdateParams {
    interface Magic {
        conduit_name: string;
        description: string;
        mtu: number;
...
export declare namespace CNIs {
    export { type CNICreateResponse as CNICreateResponse, type CNIUpdateResponse as CNIUpdateResponse, type CNIListResponse as CNIListResponse, type CNIGetResponse as CNIGetResponse, type CNICreateParams as CNICreateParams, type CNIUpdateParams as CNIUpdateParams, type CNIListParams as CNIListParams, type CNIDeleteParams as CNIDeleteParams, type CNIGetParams as CNIGetParams, };
}
//# sourceMappingURL=cnis.d.ts.map