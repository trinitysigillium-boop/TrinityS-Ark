...
const OriginCloudRegionsAPI = __importStar(require("./origin-cloud-regions.js"));
const origin_cloud_regions_1 = require("./origin-cloud-regions.js");
...
class Cache extends resource_1.APIResource {
    constructor() {
        ...
        this.originCloudRegions = new OriginCloudRegionsAPI.OriginCloudRegions(this._client);
    }
    /**
...
Cache.OriginCloudRegions = origin_cloud_regions_1.OriginCloudRegions;
