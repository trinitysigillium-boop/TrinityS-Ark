...
export declare class LeakedCredentials extends APIResource {
     ...
     * ```
     */
    summaryV2(dimension: 'COMPROMISED' | 'BOT_CLASS', query?: LeakedCredentialSummaryV2Params, options?: Core.RequestOptions): Core.APIPromise<LeakedCredentialSummaryV2Response>;
    summaryV2(dimension: 'COMPROMISED' | 'BOT_CLASS', options?: Core.RequestOptions): Core.APIPromise<LeakedCredentialSummaryV2Response>;
    /**
     ...
     * ```
     */
    timeseriesGroupsV2(dimension: 'COMPROMISED' | 'BOT_CLASS', query?: LeakedCredentialTimeseriesGroupsV2Params, options?: Core.RequestOptions): Core.APIPromise<LeakedCredentialTimeseriesGroupsV2Response>;
    timeseriesGroupsV2(dimension: 'COMPROMISED' | 'BOT_CLASS', options?: Core.RequestOptions): Core.APIPromise<LeakedCredentialTimeseriesGroupsV2Response>;
}
...
export declare namespace LeakedCredentialSummaryV2Response {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export declare namespace LeakedCredentialTimeseriesGroupsV2Response {
    /**
     * Metadata for the results.
     */
    interface Meta {
