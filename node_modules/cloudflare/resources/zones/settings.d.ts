 ...
 * 0-RTT session resumption enabled for this zone.
 */
export type SettingEditResponse = ZeroRTT | AdvancedDDoS | SettingEditResponse.ZonesCacheRulesAegis | AlwaysOnline | SettingEditResponse.ZonesSchemasAlwaysUseHTTPS | SettingEditResponse.ZonesSchemasAutomaticHTTPSRewrites | Brotli | SettingEditResponse.ZonesSchemasBrowserCacheTTL | SettingEditResponse.ZonesSchemasBrowserCheck | SettingEditResponse.ZonesSchemasCacheLevel | ChallengeTTL | SettingEditResponse.ZonesChinaNetworkEnabled | SettingEditResponse.ZonesContentConverter | Ciphers | SettingEditResponse.ZonesCNAMEFlattening | DevelopmentMode | EarlyHints | SettingEditResponse.ZonesSchemasEdgeCacheTTL | SettingEditResponse.ZonesSchemasEmailObfuscation | H2Prioritization | HotlinkProtection | HTTP2 | HTTP3 | ImageResizing | SettingEditResponse.ZonesSchemasIPGeolocation | IPV6 | SettingEditResponse.ZonesMaxUpload | MinTLSVersion | SettingEditResponse.ZonesSchemasMirage | NEL | SettingEditResponse.ZonesSchemasOpportunisticEncryption | OpportunisticOnion | OrangeToOrange | SettingEditResponse.ZonesSchemasOriginErrorPagePassThru | SettingEditResponse.ZonesCacheRulesOriginH2MaxStreams | SettingEditResponse.ZonesCacheRulesOriginMaxHTTPVersion | SettingEditResponse.ZonesSchemasPolish | PrefetchPreload | SettingEditResponse.ZonesPrivacyPass | ProxyReadTimeout | PseudoIPV4 | SettingEditResponse.ZonesRedirectsForAITraining | SettingEditResponse.ZonesReplaceInsecureJS | SettingEditResponse.ZonesSchemasResponseBuffering | SettingEditResponse.ZonesSchemasRocketLoader | SettingEditResponse.ZonesSchemasAutomaticPlatformOptimization | SettingEditResponse.ZonesSearchForAgents | SecurityHeaders | SettingEditResponse.ZonesSchemasSecurityLevel | ServerSideExcludes | SettingEditResponse.ZonesSha1Support | SettingEditResponse.ZonesSchemasSortQueryStringForCache | SettingEditResponse.ZonesSchemasSSL | SSLRecommender | SettingEditResponse.ZonesTLS1_2Only | TLS1_3 | TLSClientAuth | SettingEditResponse.ZonesTransformations | SettingEditResponse.ZonesTransformationsAllowedOrigins | SettingEditResponse.ZonesSchemasTrueClientIPHeader | SettingEditResponse.ZonesSchemasWAF | WebP | Websocket;
export declare namespace SettingEditResponse {
    ...
    namespace ZonesCacheRulesAegis {
        /**
         * Value of the zone setting.
         */
        interface Value {
 ...
 * 0-RTT session resumption enabled for this zone.
 */
export type SettingGetResponse = ZeroRTT | AdvancedDDoS | SettingGetResponse.ZonesCacheRulesAegis | AlwaysOnline | SettingGetResponse.ZonesSchemasAlwaysUseHTTPS | SettingGetResponse.ZonesSchemasAutomaticHTTPSRewrites | Brotli | SettingGetResponse.ZonesSchemasBrowserCacheTTL | SettingGetResponse.ZonesSchemasBrowserCheck | SettingGetResponse.ZonesSchemasCacheLevel | ChallengeTTL | SettingGetResponse.ZonesChinaNetworkEnabled | SettingGetResponse.ZonesContentConverter | Ciphers | SettingGetResponse.ZonesCNAMEFlattening | DevelopmentMode | EarlyHints | SettingGetResponse.ZonesSchemasEdgeCacheTTL | SettingGetResponse.ZonesSchemasEmailObfuscation | H2Prioritization | HotlinkProtection | HTTP2 | HTTP3 | ImageResizing | SettingGetResponse.ZonesSchemasIPGeolocation | IPV6 | SettingGetResponse.ZonesMaxUpload | MinTLSVersion | SettingGetResponse.ZonesSchemasMirage | NEL | SettingGetResponse.ZonesSchemasOpportunisticEncryption | OpportunisticOnion | OrangeToOrange | SettingGetResponse.ZonesSchemasOriginErrorPagePassThru | SettingGetResponse.ZonesCacheRulesOriginH2MaxStreams | SettingGetResponse.ZonesCacheRulesOriginMaxHTTPVersion | SettingGetResponse.ZonesSchemasPolish | PrefetchPreload | SettingGetResponse.ZonesPrivacyPass | ProxyReadTimeout | PseudoIPV4 | SettingGetResponse.ZonesRedirectsForAITraining | SettingGetResponse.ZonesReplaceInsecureJS | SettingGetResponse.ZonesSchemasResponseBuffering | SettingGetResponse.ZonesSchemasRocketLoader | SettingGetResponse.ZonesSchemasAutomaticPlatformOptimization | SettingGetResponse.ZonesSearchForAgents | SecurityHeaders | SettingGetResponse.ZonesSchemasSecurityLevel | ServerSideExcludes | SettingGetResponse.ZonesSha1Support | SettingGetResponse.ZonesSchemasSortQueryStringForCache | SettingGetResponse.ZonesSchemasSSL | SSLRecommender | SettingGetResponse.ZonesTLS1_2Only | TLS1_3 | TLSClientAuth | SettingGetResponse.ZonesTransformations | SettingGetResponse.ZonesTransformationsAllowedOrigins | SettingGetResponse.ZonesSchemasTrueClientIPHeader | SettingGetResponse.ZonesSchemasWAF | WebP | Websocket;
...
export declare namespace SettingEditParams {
    ...
    interface Variant1 {
         ...
         */
        value?: unknown | Variant1.ZonesCacheRulesAegisValue | Array<string> | Variant1.ZonesNELValue | number | AutomaticPlatformOptimizationParam | Variant1.ZonesSecurityHeaderValue;
    }
    namespace Variant1 {
        /**
         * Value of the zone setting.
         */
        interface ZonesCacheRulesAegisValue {
            /**
             * Whether the feature is enabled or not.
             */
            enabled?: boolean;
        ...
        namespace ZonesSecurityHeaderValue {
            /**
             * Strict Transport Security.
             */
            interface StrictTransportSecurity {
