...
export declare class Subscriptions extends APIResource {
     ...
     * ```
     */
    update(subscriptionId: string, params: SubscriptionUpdateParams, options?: Core.RequestOptions): Core.APIPromise<SubscriptionUpdateResponse>;
    /**
     ...
     * ```
     */
    list(params: SubscriptionListParams, options?: Core.RequestOptions): Core.PagePromise<SubscriptionListResponsesV4PagePaginationArray, SubscriptionListResponse>;
    /**
     ...
     * ```
     */
    delete(subscriptionId: string, params: SubscriptionDeleteParams, options?: Core.RequestOptions): Core.APIPromise<SubscriptionDeleteResponse>;
    /**
     ...
     * ```
     */
    get(subscriptionId: string, params: SubscriptionGetParams, options?: Core.RequestOptions): Core.APIPromise<SubscriptionGetResponse>;
}
export declare class SubscriptionListResponsesV4PagePaginationArray extends V4PagePaginationArray<SubscriptionListResponse> {
}
...
export declare namespace SubscriptionCreateResponse {
    ...
    interface MqEventSourceImages {
        /**
         * Type of source
         */
        type?: 'images';
    }
    interface MqEventSourceKV {
        /**
         * Type of source
         */
        type?: 'kv';
    }
    interface MqEventSourceR2 {
        /**
         * Type of source
         */
        type?: 'r2';
    }
    interface MqEventSourceSuperSlurper {
        /**
         * Type of source
         */
        type?: 'superSlurper';
    }
    interface MqEventSourceVectorize {
        /**
         * Type of source
         */
        type?: 'vectorize';
    }
    interface MqEventSourceWorkersAIModel {
        /**
    ...
    interface MqEventSourceWorkersBuildsWorker {
        /**
         * Type of source
         */
    ...
    interface MqEventSourceWorkflowsWorkflow {
        /**
         * Type of source
         */
...
export interface SubscriptionListResponse {
     ...
     * Source configuration for the subscription
     */
    source: SubscriptionListResponse.MqEventSourceImages | SubscriptionListResponse.MqEventSourceKV | SubscriptionListResponse.MqEventSourceR2 | SubscriptionListResponse.MqEventSourceSuperSlurper | SubscriptionListResponse.MqEventSourceVectorize | SubscriptionListResponse.MqEventSourceWorkersAIModel | SubscriptionListResponse.MqEventSourceWorkersBuildsWorker | SubscriptionListResponse.MqEventSourceWorkflowsWorkflow;
}
