...
export interface PhaseUpdateResponse {
     ...
     */
    rules: Array<RulesAPI.BlockRule | PhaseUpdateResponse.RulesetsChallengeRule | RulesAPI.CompressResponseRule | RulesAPI.DDoSDynamicRule | RulesAPI.ExecuteRule | RulesAPI.ForceConnectionCloseRule | PhaseUpdateResponse.RulesetsJSChallengeRule | RulesAPI.LogRule | RulesAPI.LogCustomFieldRule | RulesAPI.ManagedChallengeRule | RulesAPI.RedirectRule | RulesAPI.RewriteRule | RulesAPI.RouteRule | RulesAPI.ScoreRule | RulesAPI.ServeErrorRule | PhaseUpdateResponse.RulesetsSetCacheControlRule | RulesAPI.SetCacheSettingsRule | PhaseUpdateResponse.RulesetsSetCacheTagsRule | RulesAPI.SetConfigRule | RulesAPI.SkipRule>;
    /**
...
export interface PhaseGetResponse {
     ...
     * The list of rules in the ruleset.
     */
    rules: Array<RulesAPI.BlockRule | PhaseGetResponse.RulesetsChallengeRule | RulesAPI.CompressResponseRule | RulesAPI.DDoSDynamicRule | RulesAPI.ExecuteRule | RulesAPI.ForceConnectionCloseRule | PhaseGetResponse.RulesetsJSChallengeRule | RulesAPI.LogRule | RulesAPI.LogCustomFieldRule | RulesAPI.ManagedChallengeRule | RulesAPI.RedirectRule | RulesAPI.RewriteRule | RulesAPI.RouteRule | RulesAPI.ScoreRule | RulesAPI.ServeErrorRule | PhaseGetResponse.RulesetsSetCacheControlRule | RulesAPI.SetCacheSettingsRule | PhaseGetResponse.RulesetsSetCacheTagsRule | RulesAPI.SetConfigRule | RulesAPI.SkipRule>;
    /**
     * The version of the ruleset.
     */
    version: string;
...
export interface PhaseUpdateParams {
     ...
     */
    rules?: Array<RulesAPI.BlockRuleParam | PhaseUpdateParams.RulesetsChallengeRule | RulesAPI.CompressResponseRuleParam | RulesAPI.DDoSDynamicRuleParam | RulesAPI.ExecuteRuleParam | RulesAPI.ForceConnectionCloseRuleParam | PhaseUpdateParams.RulesetsJSChallengeRule | RulesAPI.LogRuleParam | RulesAPI.LogCustomFieldRuleParam | RulesAPI.ManagedChallengeRuleParam | RulesAPI.RedirectRuleParam | RulesAPI.RewriteRuleParam | RulesAPI.RouteRuleParam | RulesAPI.ScoreRuleParam | RulesAPI.ServeErrorRuleParam | PhaseUpdateParams.RulesetsSetCacheControlRule | RulesAPI.SetCacheSettingsRuleParam | PhaseUpdateParams.RulesetsSetCacheTagsRule | RulesAPI.SetConfigRuleParam | RulesAPI.SkipRuleParam>;
}
