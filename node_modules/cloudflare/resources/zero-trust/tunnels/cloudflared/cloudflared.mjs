...
import { CloudflareTunnelsV4PagePaginationArray } from "../../../shared.mjs";
...
export class Cloudflared extends APIResource {
    ...
    list(params, options) {
        ...
        return this._client.getAPIList(`/accounts/${account_id}/cfd_tunnel`, CloudflareTunnelsV4PagePaginationArray, { query, ...options });
    }
    /**
