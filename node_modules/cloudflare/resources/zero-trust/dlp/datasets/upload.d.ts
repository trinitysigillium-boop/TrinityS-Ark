...
export declare class Upload extends APIResource {
     ...
     * ```
     */
    edit(datasetId: string, version: number, dataset: string | ArrayBufferView | ArrayBuffer | BlobLike, params: UploadEditParams, options?: Core.RequestOptions): Core.APIPromise<DatasetsAPI.Dataset>;
}
