...
export declare class Rules extends APIResource {
     ...
     * ```
     */
    list(params: RuleListParams, options?: Core.RequestOptions): Core.PagePromise<RuleListResponsesV4PagePaginationArray, RuleListResponse>;
    /**
     ...
     * ```
     */
    bulkDelete(params: RuleBulkDeleteParams, options?: Core.RequestOptions): Core.APIPromise<RuleBulkDeleteResponse>;
}
...
export declare namespace RuleBulkDeleteResponse {
    interface Error {
        code: number;
        message: string;
