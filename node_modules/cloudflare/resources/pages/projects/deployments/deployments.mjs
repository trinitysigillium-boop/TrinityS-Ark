...
import { DeploymentsV4PagePaginationArray } from "../projects.mjs";
...
export class Deployments extends APIResource {
    ...
    list(projectName, params, options) {
        ...
        return this._client.getAPIList(`/accounts/${account_id}/pages/projects/${projectName}/deployments`, DeploymentsV4PagePaginationArray, { query, ...options });
    }
    /**
     * Delete a deployment.
     *
