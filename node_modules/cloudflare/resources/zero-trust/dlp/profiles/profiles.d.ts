...
import { Predefined, PredefinedDeleteParams, PredefinedDeleteResponse, PredefinedGetParams, PredefinedProfile as PredefinedAPIPredefinedProfile, PredefinedUpdateParams } from "./predefined.js";
...
export declare namespace Profile {
    interface CustomProfile {
         ...
         * @deprecated
         */
        entries?: Array<CustomProfile.CustomEntry | CustomProfile.CustomPromptTopicEntry | CustomProfile.PredefinedEntry | CustomProfile.IntegrationEntry | CustomProfile.ExactDataEntry | CustomProfile.DocumentFingerprintEntry | CustomProfile.WordListEntry>;
        /**
         * Sensitivity levels associated with this profile.
         */
        sensitivity_levels?: Array<CustomProfile.SensitivityLevel>;
        shared_entries?: Array<CustomProfile.CustomEntry | CustomProfile.CustomPromptTopicEntry | CustomProfile.PredefinedEntry | CustomProfile.IntegrationEntry | CustomProfile.ExactDataEntry | CustomProfile.DocumentFingerprintEntry | CustomProfile.WordListEntry>;
    }
    namespace CustomProfile {
        ...
        interface CustomPromptTopicEntry {
            id: string;
            created_at: string;
            /**
             * @deprecated
    ...
    interface PredefinedProfile {
         ...
         * @deprecated
         */
        entries: Array<PredefinedProfile.CustomEntry | PredefinedProfile.CustomPromptTopicEntry | PredefinedProfile.PredefinedEntry | PredefinedProfile.IntegrationEntry | PredefinedProfile.ExactDataEntry | PredefinedProfile.DocumentFingerprintEntry | PredefinedProfile.WordListEntry>;
        /**
    ...
    interface IntegrationProfile {
         ...
         * @deprecated
         */
        entries: Array<IntegrationProfile.CustomEntry | IntegrationProfile.CustomPromptTopicEntry | IntegrationProfile.PredefinedEntry | IntegrationProfile.IntegrationEntry | IntegrationProfile.ExactDataEntry | IntegrationProfile.DocumentFingerprintEntry | IntegrationProfile.WordListEntry>;
        name: string;
        shared_entries: Array<IntegrationProfile.CustomEntry | IntegrationProfile.CustomPromptTopicEntry | IntegrationProfile.PredefinedEntry | IntegrationProfile.IntegrationEntry | IntegrationProfile.ExactDataEntry | IntegrationProfile.DocumentFingerprintEntry | IntegrationProfile.WordListEntry>;
        type: 'integration';
        updated_at: string;
        /**
         * The description of the profile.
...
export declare namespace Profiles {
    ...
    export { Predefined as Predefined, type PredefinedAPIPredefinedProfile as PredefinedProfile, type PredefinedDeleteResponse as PredefinedDeleteResponse, type PredefinedUpdateParams as PredefinedUpdateParams, type PredefinedDeleteParams as PredefinedDeleteParams, type PredefinedGetParams as PredefinedGetParams, };
}
