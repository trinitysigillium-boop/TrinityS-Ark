...
export declare class BlockSenders extends APIResource {
     ...
     * ```
     */
    delete(patternId: string, params: BlockSenderDeleteParams, options?: Core.RequestOptions): Core.APIPromise<BlockSenderDeleteResponse>;
    /**
     ...
     * ```
     */
    edit(patternId: string, params: BlockSenderEditParams, options?: Core.RequestOptions): Core.APIPromise<BlockSenderEditResponse>;
    /**
     ...
     * ```
     */
    get(patternId: string, params: BlockSenderGetParams, options?: Core.RequestOptions): Core.APIPromise<BlockSenderGetResponse>;
}
