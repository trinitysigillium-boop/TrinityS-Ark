...
exports.SnippetListResponsesV4PagePaginationArray = exports.Snippets = void 0;
...
class Snippets extends resource_1.APIResource {
    ...
    update(snippetName, params, options) {
        ...
        return this._client.put(`/zones/${zone_id}/snippets/${snippetName}`, Core.multipartFormRequestOptions({ body, ...options, __multipartSyntax: 'json' }))._thenUnwrap((obj) => obj.result);
    }
    /**
...
class SnippetListResponsesV4PagePaginationArray extends pagination_1.V4PagePaginationArray {
}
exports.SnippetListResponsesV4PagePaginationArray = SnippetListResponsesV4PagePaginationArray;
