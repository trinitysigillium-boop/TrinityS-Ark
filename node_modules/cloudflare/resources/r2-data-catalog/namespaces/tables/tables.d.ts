...
import * as MaintenanceConfigsAPI from "./maintenance-configs.js";
import { MaintenanceConfigGetParams, MaintenanceConfigGetResponse, MaintenanceConfigUpdateParams, MaintenanceConfigUpdateResponse, MaintenanceConfigs } from "./maintenance-configs.js";
export declare class Tables extends APIResource {
    maintenanceConfigs: MaintenanceConfigsAPI.MaintenanceConfigs;
    /**
     ...
     * ```
     */
    list(bucketName: string, namespace: string, params: TableListParams, options?: Core.RequestOptions): Core.APIPromise<TableListResponse>;
}
/**
...
export declare namespace TableListResponse {
    /**
...
export declare namespace Tables {
    ...
    export { MaintenanceConfigs as MaintenanceConfigs, type MaintenanceConfigUpdateResponse as MaintenanceConfigUpdateResponse, type MaintenanceConfigGetResponse as MaintenanceConfigGetResponse, type MaintenanceConfigUpdateParams as MaintenanceConfigUpdateParams, type MaintenanceConfigGetParams as MaintenanceConfigGetParams, };
}
