...
import { Configuration, ConfigurationGetParams, ConfigurationUpdateParams, Configurations } from "./configurations.js";
...
import * as LabelsAPI from "./labels/labels.js";
import { LabelListParams, LabelListResponse, LabelListResponsesV4PagePaginationArray, Labels } from "./labels/labels.js";
...
import { Message, OldPublicSchema, OldPublicSchemasV4PagePaginationArray, UserSchemaCreateParams, UserSchemaCreateResponse, UserSchemaDeleteParams, UserSchemaDeleteResponse, UserSchemaEditParams, UserSchemaGetParams, UserSchemaListParams, UserSchemas } from "./user-schemas/user-schemas.js";
...
export declare namespace APIGateway {
    export { Configurations as Configurations, type Configuration as Configuration, type ConfigurationUpdateParams as ConfigurationUpdateParams, type ConfigurationGetParams as ConfigurationGetParams, };
    ...
    export { Labels as Labels, type LabelListResponse as LabelListResponse, LabelListResponsesV4PagePaginationArray as LabelListResponsesV4PagePaginationArray, type LabelListParams as LabelListParams, };
