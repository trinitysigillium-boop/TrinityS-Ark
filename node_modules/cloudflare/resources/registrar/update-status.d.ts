...
import * as RegistrarAPI from "./registrar.js";
export declare class UpdateStatus extends APIResource {
    /**
     ...
     * ```
     */
    get(domainName: string, params: UpdateStatusGetParams, options?: Core.RequestOptions): Core.APIPromise<RegistrarAPI.WorkflowStatus>;
}
