...
import { Integration, IntegrationCreateParams, IntegrationDeleteParams, IntegrationDeleteResponse, IntegrationEditParams, IntegrationGetParams, IntegrationListParams, Integrations, IntegrationsSinglePage } from "./integrations.js";
 ...
 */
export type DeviceInput = FileInput | UniqueClientIDInput | DomainJoinedInput | OSVersionInput | FirewallInput | SentineloneInput | DeviceInput.TeamsDevicesCarbonblackInputRequest | DeviceInput.TeamsDevicesAccessSerialNumberListInputRequest | DiskEncryptionInput | DeviceInput.TeamsDevicesApplicationInputRequest | ClientCertificateInput | DeviceInput.TeamsDevicesClientCertificateV2InputRequest | DeviceInput.TeamsDevicesAntivirusInputRequest | WorkspaceOneInput | CrowdstrikeInput | IntuneInput | KolideInput | TaniumInput | SentineloneS2sInput | DeviceInput.TeamsDevicesCustomS2sInputRequest;
export declare namespace DeviceInput {
    ...
    interface TeamsDevicesAccessSerialNumberListInputRequest {
        /**
         * UUID of Access List.
         */
        id: string;
    ...
    interface TeamsDevicesClientCertificateV2InputRequest {
        /**
         * UUID of Cloudflare managed certificate.
         */
        certificate_id: string;
    ...
    namespace TeamsDevicesClientCertificateV2InputRequest {
        interface Locations {
            /**
    ...
    interface TeamsDevicesAntivirusInputRequest {
        /**
         * Number of days that the antivirus should be updated within.
         */
        update_window_days?: number;
    }
    interface TeamsDevicesCustomS2sInputRequest {
        /**
         * Posture Integration ID.
         */
        connection_id: string;
 ...
 * The value to be checked against.
 */
export type DeviceInputParam = FileInputParam | UniqueClientIDInputParam | DomainJoinedInputParam | OSVersionInputParam | FirewallInputParam | SentineloneInputParam | DeviceInputParam.TeamsDevicesCarbonblackInputRequest | DeviceInputParam.TeamsDevicesAccessSerialNumberListInputRequest | DiskEncryptionInputParam | DeviceInputParam.TeamsDevicesApplicationInputRequest | ClientCertificateInputParam | DeviceInputParam.TeamsDevicesClientCertificateV2InputRequest | DeviceInputParam.TeamsDevicesAntivirusInputRequest | WorkspaceOneInputParam | CrowdstrikeInputParam | IntuneInputParam | KolideInputParam | TaniumInputParam | SentineloneS2sInputParam | DeviceInputParam.TeamsDevicesCustomS2sInputRequest;
export declare namespace DeviceInputParam {
    interface TeamsDevicesCarbonblackInputRequest {
        /**
         * Operating system.
         */
...
export interface DevicePostureRule {
     ...
     */
    type?: 'file' | 'application' | 'tanium' | 'gateway' | 'warp' | 'disk_encryption' | 'serial_number' | 'sentinelone' | 'carbonblack' | 'firewall' | 'os_version' | 'domain_joined' | 'client_certificate' | 'client_certificate_v2' | 'antivirus' | 'unique_client_id' | 'kolide' | 'tanium_s2s' | 'crowdstrike_s2s' | 'intune' | 'workspace_one' | 'sentinelone_s2s' | 'custom_s2s';
}
...
export interface SentineloneS2sInput {
     ...
     */
    operational_state?: 'na' | 'partially_disabled' | 'auto_fully_disabled' | 'fully_disabled' | 'auto_partially_disabled' | 'disabled_error' | 'db_corruption';
    /**
     * Operator.
     */
    operator?: '<' | '<=' | '>' | '>=' | '==';
