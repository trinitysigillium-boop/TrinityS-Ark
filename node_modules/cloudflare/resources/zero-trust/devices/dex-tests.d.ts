...
export declare class DEXTests extends APIResource {
     ...
     * ```
     */
    update(dexTestId: string, params: DEXTestUpdateParams, options?: Core.RequestOptions): Core.APIPromise<DEXTestUpdateResponse>;
    /**
     * Fetch all DEX tests
     *
     * @example
     ...
     * ```
     */
    list(params: DEXTestListParams, options?: Core.RequestOptions): Core.PagePromise<DEXTestListResponsesV4PagePaginationArray, DEXTestListResponse>;
    /**
     ...
     * ```
     */
    get(dexTestId: string, params: DEXTestGetParams, options?: Core.RequestOptions): Core.APIPromise<DEXTestGetResponse>;
}
export declare class DEXTestListResponsesV4PagePaginationArray extends V4PagePaginationArray<DEXTestListResponse> {
}
/**
...
export declare namespace DEXTestCreateResponse {
    /**
     * The configuration object which contains the details for the WARP client to
     * conduct the test.
     */
...
export declare namespace DEXTestUpdateResponse {
    /**
     * The configuration object which contains the details for the WARP client to
     * conduct the test.
     */
...
export declare namespace DEXTestListResponse {
    /**
     * The configuration object which contains the details for the WARP client to
     * conduct the test.
     */
...
export declare namespace DEXTestDeleteResponse {
    interface DEXTest {
        /**
         * The configuration object which contains the details for the WARP client to
         * conduct the test.
...
export declare namespace DEXTestGetResponse {
    /**
     * The configuration object which contains the details for the WARP client to
     * conduct the test.
     */
