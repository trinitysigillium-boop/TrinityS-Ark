...
const AIControlsAPI = __importStar(require("./ai-controls/ai-controls.js"));
const ai_controls_1 = require("./ai-controls/ai-controls.js");
...
Access.CertificatesV4PagePaginationArray = certificates_1.CertificatesV4PagePaginationArray;
Access.Groups = groups_1.Groups;
Access.GroupListResponsesV4PagePaginationArray = groups_1.GroupListResponsesV4PagePaginationArray;
Access.ServiceTokens = service_tokens_1.ServiceTokens;
Access.ServiceTokensV4PagePaginationArray = service_tokens_1.ServiceTokensV4PagePaginationArray;
...
Access.UserListResponsesV4PagePaginationArray = users_1.UserListResponsesV4PagePaginationArray;
Access.CustomPages = custom_pages_1.CustomPages;
Access.CustomPageWithoutHTMLsV4PagePaginationArray = custom_pages_1.CustomPageWithoutHTMLsV4PagePaginationArray;
Access.Tags = tags_1.Tags;
Access.TagsV4PagePaginationArray = tags_1.TagsV4PagePaginationArray;
Access.Policies = policies_1.Policies;
Access.PolicyListResponsesV4PagePaginationArray = policies_1.PolicyListResponsesV4PagePaginationArray;
