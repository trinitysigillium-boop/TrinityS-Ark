...
export declare class Crawl extends APIResource {
     ...
     * ```
     */
    delete(jobId: string, params: CrawlDeleteParams, options?: Core.RequestOptions): Core.APIPromise<CrawlDeleteResponse>;
    /**
     ...
     * ```
     */
    get(jobId: string, params: CrawlGetParams, options?: Core.RequestOptions): Core.APIPromise<CrawlGetResponse>;
}
/**
 * Crawl job ID.
 */
...
export declare namespace CrawlGetResponse {
    interface Record {
    ...
    namespace Variant0 {
        ...
        namespace JsonOptions {
            ...
            interface ResponseFormat {
                 ...
                 */
                json_schema?: {
                    [key: string]: string | number | boolean | unknown | Array<string>;
                } | null;
            }
        }
        /**
...
export declare namespace Crawl {
    export { type CrawlCreateResponse as CrawlCreateResponse, type CrawlDeleteResponse as CrawlDeleteResponse, type CrawlGetResponse as CrawlGetResponse, type CrawlCreateParams as CrawlCreateParams, type CrawlDeleteParams as CrawlDeleteParams, type CrawlGetParams as CrawlGetParams, };
}
