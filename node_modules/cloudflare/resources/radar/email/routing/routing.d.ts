...
export declare class Routing extends APIResource {
     ...
     * ```
     */
    summaryV2(dimension: 'IP_VERSION' | 'ENCRYPTED' | 'ARC' | 'DKIM' | 'DMARC' | 'SPF', query?: RoutingSummaryV2Params, options?: Core.RequestOptions): Core.APIPromise<RoutingSummaryV2Response>;
    summaryV2(dimension: 'IP_VERSION' | 'ENCRYPTED' | 'ARC' | 'DKIM' | 'DMARC' | 'SPF', options?: Core.RequestOptions): Core.APIPromise<RoutingSummaryV2Response>;
    /**
     ...
     * ```
     */
    timeseriesGroupsV2(dimension: 'IP_VERSION' | 'ENCRYPTED' | 'ARC' | 'DKIM' | 'DMARC' | 'SPF', query?: RoutingTimeseriesGroupsV2Params, options?: Core.RequestOptions): Core.APIPromise<RoutingTimeseriesGroupsV2Response>;
    timeseriesGroupsV2(dimension: 'IP_VERSION' | 'ENCRYPTED' | 'ARC' | 'DKIM' | 'DMARC' | 'SPF', options?: Core.RequestOptions): Core.APIPromise<RoutingTimeseriesGroupsV2Response>;
}
...
export declare namespace RoutingSummaryV2Response {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export declare namespace RoutingTimeseriesGroupsV2Response {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export declare namespace Routing {
    export { type RoutingSummaryV2Response as RoutingSummaryV2Response, type RoutingTimeseriesGroupsV2Response as RoutingTimeseriesGroupsV2Response, type RoutingSummaryV2Params as RoutingSummaryV2Params, type RoutingTimeseriesGroupsV2Params as RoutingTimeseriesGroupsV2Params, };
