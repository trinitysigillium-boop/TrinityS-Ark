...
import * as SippyAPI from "../../../r2/buckets/sippy.js";
import * as ItemsAPI from "./items.js";
import { ItemChunksParams, ItemChunksResponse, ItemCreateOrUpdateParams, ItemCreateOrUpdateResponse, ItemDeleteParams, ItemDeleteResponse, ItemDownloadParams, ItemGetParams, ItemGetResponse, ItemListParams, ItemListResponse, ItemListResponsesV4PagePaginationArray, ItemLogsParams, ItemLogsResponse, ItemSyncParams, ItemSyncResponse, ItemUploadParams, ItemUploadResponse, Items } from "./items.js";
import * as JobsAPI from "./jobs.js";
import { JobCreateParams, JobCreateResponse, JobGetParams, JobGetResponse, JobListParams, JobListResponse, JobListResponsesV4PagePaginationArray, JobLogsParams, JobLogsResponse, JobUpdateParams, JobUpdateResponse, Jobs } from "./jobs.js";
...
export declare class Instances extends APIResource {
     ...
     * ```
     */
    create(name: string, params: InstanceCreateParams, options?: Core.RequestOptions): Core.APIPromise<InstanceCreateResponse>;
    /**
     * Update instance.
     *
     * @example
     ...
     * ```
     */
    update(name: string, id: string, params: InstanceUpdateParams, options?: Core.RequestOptions): Core.APIPromise<InstanceUpdateResponse>;
    /**
     * List instances.
     *
     * @example
     ...
     * ```
     */
    list(name: string, params: InstanceListParams, options?: Core.RequestOptions): Core.PagePromise<InstanceListResponsesV4PagePaginationArray, InstanceListResponse>;
    /**
     * Delete instance.
     *
     * @example
     ...
     * ```
     */
    delete(name: string, id: string, params: InstanceDeleteParams, options?: Core.RequestOptions): Core.APIPromise<InstanceDeleteResponse>;
    /**
     ...
     * ```
     */
    chatCompletions(name: string, id: string, params: InstanceChatCompletionsParams, options?: Core.RequestOptions): Core.APIPromise<InstanceChatCompletionsResponse>;
    /**
     * Read instance.
     *
     * @example
     ...
     * ```
     */
    read(name: string, id: string, params: InstanceReadParams, options?: Core.RequestOptions): Core.APIPromise<InstanceReadResponse>;
    /**
     ...
     * ```
     */
    search(name: string, id: string, params: InstanceSearchParams, options?: Core.RequestOptions): Core.APIPromise<InstanceSearchResponse>;
    /**
     ...
     * ```
     */
    stats(name: string, id: string, params: InstanceStatsParams, options?: Core.RequestOptions): Core.APIPromise<InstanceStatsResponse>;
}
...
export declare namespace InstanceCreateResponse {
    ...
    namespace PublicEndpointParams {
...
export declare namespace InstanceUpdateResponse {
    interface CustomMetadata {
        data_type: 'text' | 'number' | 'boolean' | 'datetime';
        field_name: string;
    }
...
export declare namespace InstanceDeleteResponse {
    interface CustomMetadata {
        data_type: 'text' | 'number' | 'boolean' | 'datetime';
        field_name: string;
    }
...
export declare namespace InstanceChatCompletionsResponse {
    interface Choice {
...
export declare namespace InstanceReadResponse {
    interface CustomMetadata {
        data_type: 'text' | 'number' | 'boolean' | 'datetime';
        field_name: string;
    }
...
export declare namespace InstanceSearchResponse {
    interface Chunk {
        id: string;
        score: number;
        text: string;
...
export declare namespace InstanceStatsResponse {
    /**
     * Engine-specific metadata. Present only for managed (v3) instances.
     */
    interface Engine {
...
export declare namespace InstanceCreateParams {
    interface CustomMetadata {
        data_type: 'text' | 'number' | 'boolean' | 'datetime';
        field_name: string;
    }
...
export declare namespace InstanceUpdateParams {
    interface CustomMetadata {
        data_type: 'text' | 'number' | 'boolean' | 'datetime';
        field_name: string;
    }
...
export declare namespace InstanceChatCompletionsParams {
    interface Message {
        content: string | null;
        role: 'system' | 'developer' | 'user' | 'assistant' | 'tool';
        [k: string]: unknown;
...
export declare namespace InstanceSearchParams {
    interface AISearchOptions {
        cache?: AISearchOptions.Cache;
        query_rewrite?: AISearchOptions.QueryRewrite;
        reranking?: AISearchOptions.Reranking;
...
export declare namespace Instances {
    ...
    export { Jobs as Jobs, type JobCreateResponse as JobCreateResponse, type JobUpdateResponse as JobUpdateResponse, type JobListResponse as JobListResponse, type JobGetResponse as JobGetResponse, type JobLogsResponse as JobLogsResponse, JobListResponsesV4PagePaginationArray as JobListResponsesV4PagePaginationArray, type JobCreateParams as JobCreateParams, type JobUpdateParams as JobUpdateParams, type JobListParams as JobListParams, type JobGetParams as JobGetParams, type JobLogsParams as JobLogsParams, };
    export { Items as Items, type ItemListResponse as ItemListResponse, type ItemDeleteResponse as ItemDeleteResponse, type ItemChunksResponse as ItemChunksResponse, type ItemCreateOrUpdateResponse as ItemCreateOrUpdateResponse, type ItemGetResponse as ItemGetResponse, type ItemLogsResponse as ItemLogsResponse, type ItemSyncResponse as ItemSyncResponse, type ItemUploadResponse as ItemUploadResponse, ItemListResponsesV4PagePaginationArray as ItemListResponsesV4PagePaginationArray, type ItemListParams as ItemListParams, type ItemDeleteParams as ItemDeleteParams, type ItemChunksParams as ItemChunksParams, type ItemCreateOrUpdateParams as ItemCreateOrUpdateParams, type ItemDownloadParams as ItemDownloadParams, type ItemGetParams as ItemGetParams, type ItemLogsParams as ItemLogsParams, type ItemSyncParams as ItemSyncParams, type ItemUploadParams as ItemUploadParams, };
}
