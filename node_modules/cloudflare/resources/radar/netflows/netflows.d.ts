...
export declare class NetFlows extends APIResource {
     ...
     */
    summary(query?: NetFlowsSummaryParams, options?: Core.RequestOptions): Core.APIPromise<NetFlowsSummaryResponse>;
     ...
     * ```
     */
    summaryV2(dimension: 'ADM1' | 'AS' | 'LOCATION' | 'PRODUCT', query?: NetFlowsSummaryV2Params, options?: Core.RequestOptions): Core.APIPromise<NetFlowsSummaryV2Response>;
    summaryV2(dimension: 'ADM1' | 'AS' | 'LOCATION' | 'PRODUCT', options?: Core.RequestOptions): Core.APIPromise<NetFlowsSummaryV2Response>;
    /**
     ...
     * ```
     */
    timeseries(query?: NetFlowsTimeseriesParams, options?: Core.RequestOptions): Core.APIPromise<NetFlowsTimeseriesResponse>;
     ...
     * ```
     */
    timeseriesGroups(dimension: 'ADM1' | 'AS' | 'LOCATION' | 'PRODUCT', query?: NetFlowsTimeseriesGroupsParams, options?: Core.RequestOptions): Core.APIPromise<NetFlowsTimeseriesGroupsResponse>;
    timeseriesGroups(dimension: 'ADM1' | 'AS' | 'LOCATION' | 'PRODUCT', options?: Core.RequestOptions): Core.APIPromise<NetFlowsTimeseriesGroupsResponse>;
}
...
export declare namespace NetFlowsSummaryResponse {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export declare namespace NetFlowsSummaryV2Response {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export declare namespace NetFlowsTimeseriesResponse {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export declare namespace NetFlowsTimeseriesGroupsResponse {
    /**
     * Metadata for the results.
     */
    interface Meta {
