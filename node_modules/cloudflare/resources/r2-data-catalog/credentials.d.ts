...
export declare class Credentials extends APIResource {
     ...
     * ```
     */
    create(bucketName: string, params: CredentialCreateParams, options?: Core.RequestOptions): Core.APIPromise<CredentialCreateResponse | null>;
}
...
export declare namespace Credentials {
    export { type CredentialCreateResponse as CredentialCreateResponse, type CredentialCreateParams as CredentialCreateParams, };
}
