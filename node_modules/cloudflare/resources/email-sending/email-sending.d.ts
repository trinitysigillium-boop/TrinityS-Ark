...
import * as SubdomainsAPI from "./subdomains/subdomains.js";
import { SubdomainCreateParams, SubdomainCreateResponse, SubdomainDeleteParams, SubdomainDeleteResponse, SubdomainGetParams, SubdomainGetResponse, SubdomainListParams, SubdomainListResponse, SubdomainListResponsesSinglePage, Subdomains } from "./subdomains/subdomains.js";
export declare class EmailSending extends APIResource {
     ...
     * ```
     */
    send(params: EmailSendingSendParams, options?: Core.RequestOptions): Core.APIPromise<EmailSendingSendResponse>;
    /**
     ...
     * ```
     */
    sendRaw(params: EmailSendingSendRawParams, options?: Core.RequestOptions): Core.APIPromise<EmailSendingSendRawResponse>;
}
...
export interface EmailSendingSendParams {
     ...
     */
    attachments?: Array<EmailSendingSendParams.EmailSendingEmailInlineAttachment | EmailSendingSendParams.EmailSendingEmailAttachment>;
    /**
...
export declare namespace EmailSendingSendParams {
...
export declare namespace EmailSending {
    export { type EmailSendingSendResponse as EmailSendingSendResponse, type EmailSendingSendRawResponse as EmailSendingSendRawResponse, type EmailSendingSendParams as EmailSendingSendParams, type EmailSendingSendRawParams as EmailSendingSendRawParams, };
    export { Subdomains as Subdomains, type SubdomainCreateResponse as SubdomainCreateResponse, type SubdomainListResponse as SubdomainListResponse, type SubdomainDeleteResponse as SubdomainDeleteResponse, type SubdomainGetResponse as SubdomainGetResponse, SubdomainListResponsesSinglePage as SubdomainListResponsesSinglePage, type SubdomainCreateParams as SubdomainCreateParams, type SubdomainListParams as SubdomainListParams, type SubdomainDeleteParams as SubdomainDeleteParams, type SubdomainGetParams as SubdomainGetParams, };
}
