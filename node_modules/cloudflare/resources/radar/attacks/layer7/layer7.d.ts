...
import { Summary, SummaryHTTPMethodParams, SummaryHTTPMethodResponse, SummaryHTTPVersionParams, SummaryHTTPVersionResponse, SummaryIPVersionParams, SummaryIPVersionResponse, SummaryIndustryParams, SummaryIndustryResponse, SummaryManagedRulesParams, SummaryManagedRulesResponse, SummaryMitigationProductParams, SummaryMitigationProductResponse, SummaryVerticalParams, SummaryVerticalResponse } from "./summary.js";
import * as TimeseriesGroupsAPI from "./timeseries-groups.js";
import { TimeseriesGroupHTTPMethodParams, TimeseriesGroupHTTPMethodResponse, TimeseriesGroupHTTPVersionParams, TimeseriesGroupHTTPVersionResponse, TimeseriesGroupIPVersionParams, TimeseriesGroupIPVersionResponse, TimeseriesGroupIndustryParams, TimeseriesGroupIndustryResponse, TimeseriesGroupManagedRulesParams, TimeseriesGroupManagedRulesResponse, TimeseriesGroupMitigationProductParams, TimeseriesGroupMitigationProductResponse, TimeseriesGroupVerticalParams, TimeseriesGroupVerticalResponse, TimeseriesGroups } from "./timeseries-groups.js";
...
export declare class Layer7 extends APIResource {
     ...
     * ```
     */
    summaryV2(dimension: 'HTTP_METHOD' | 'HTTP_VERSION' | 'IP_VERSION' | 'MANAGED_RULES' | 'MITIGATION_PRODUCT' | 'VERTICAL' | 'INDUSTRY', query?: Layer7SummaryV2Params, options?: Core.RequestOptions): Core.APIPromise<Layer7SummaryV2Response>;
    summaryV2(dimension: 'HTTP_METHOD' | 'HTTP_VERSION' | 'IP_VERSION' | 'MANAGED_RULES' | 'MITIGATION_PRODUCT' | 'VERTICAL' | 'INDUSTRY', options?: Core.RequestOptions): Core.APIPromise<Layer7SummaryV2Response>;
    /**
     ...
     * ```
     */
    timeseriesGroupsV2(dimension: 'HTTP_METHOD' | 'HTTP_VERSION' | 'IP_VERSION' | 'MANAGED_RULES' | 'MITIGATION_PRODUCT' | 'VERTICAL' | 'INDUSTRY', query?: Layer7TimeseriesGroupsV2Params, options?: Core.RequestOptions): Core.APIPromise<Layer7TimeseriesGroupsV2Response>;
    timeseriesGroupsV2(dimension: 'HTTP_METHOD' | 'HTTP_VERSION' | 'IP_VERSION' | 'MANAGED_RULES' | 'MITIGATION_PRODUCT' | 'VERTICAL' | 'INDUSTRY', options?: Core.RequestOptions): Core.APIPromise<Layer7TimeseriesGroupsV2Response>;
}
...
export declare namespace Layer7SummaryV2Response {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export declare namespace Layer7TimeseriesGroupsV2Response {
    /**
     * Metadata for the results.
     */
    interface Meta {
