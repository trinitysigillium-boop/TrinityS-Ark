...
export declare namespace RecipientCreateResponse {
    interface Resource {
        /**
...
export declare namespace RecipientListResponse {
    interface Resource {
        /**
         * Share Recipient error message.
         */
...
export declare namespace RecipientDeleteResponse {
    interface Resource {
        /**
         * Share Recipient error message.
         */
...
export declare namespace RecipientGetResponse {
    interface Resource {
        /**
         * Share Recipient error message.
         */
