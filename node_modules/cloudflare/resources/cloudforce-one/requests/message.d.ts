...
export declare class MessageResource extends APIResource {
     ...
     * ```
     */
    create(requestId: string, params: MessageCreateParams, options?: Core.RequestOptions): Core.APIPromise<Message>;
    /**
     ...
     * ```
     */
    update(requestId: string, messageId: number, params: MessageUpdateParams, options?: Core.RequestOptions): Core.APIPromise<Message>;
    /**
     ...
     * ```
     */
    delete(requestId: string, messageId: number, params: MessageDeleteParams, options?: Core.RequestOptions): Core.APIPromise<MessageDeleteResponse>;
    /**
     ...
     * ```
     */
    get(requestId: string, params: MessageGetParams, options?: Core.RequestOptions): Core.PagePromise<MessagesSinglePage, Message>;
}
...
export declare namespace MessageDeleteResponse {
    interface Error {
        code: number;
        message: string;
...
export declare namespace MessageResource {
    export { type Message as Message, type MessageDeleteResponse as MessageDeleteResponse, MessagesSinglePage as MessagesSinglePage, type MessageCreateParams as MessageCreateParams, type MessageUpdateParams as MessageUpdateParams, type MessageDeleteParams as MessageDeleteParams, type MessageGetParams as MessageGetParams, };
}
