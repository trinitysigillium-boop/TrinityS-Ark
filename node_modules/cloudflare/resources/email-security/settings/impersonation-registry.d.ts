...
export declare class ImpersonationRegistry extends APIResource {
     ...
     * ```
     */
    delete(impersonationRegistryId: string, params: ImpersonationRegistryDeleteParams, options?: Core.RequestOptions): Core.APIPromise<ImpersonationRegistryDeleteResponse>;
    /**
     ...
     * ```
     */
    edit(impersonationRegistryId: string, params: ImpersonationRegistryEditParams, options?: Core.RequestOptions): Core.APIPromise<ImpersonationRegistryEditResponse>;
    /**
     ...
     * ```
     */
    get(impersonationRegistryId: string, params: ImpersonationRegistryGetParams, options?: Core.RequestOptions): Core.APIPromise<ImpersonationRegistryGetResponse>;
}
