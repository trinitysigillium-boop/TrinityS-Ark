...
export declare class Stores extends APIResource {
     ...
     * ```
     */
    delete(storeId: string, params: StoreDeleteParams, options?: Core.RequestOptions): Core.APIPromise<StoreDeleteResponse | null>;
}
