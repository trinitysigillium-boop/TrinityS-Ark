...
import { AssetCreateParams, AssetCreateResponse, AssetDeleteParams, AssetGetParams, AssetGetResponse, AssetListParams, AssetListResponse, AssetListResponsesV4PagePaginationArray, AssetUpdateParams, AssetUpdateResponse, Assets } from "./assets.js";
...
export declare class CustomPages extends APIResource {
     ...
     * ```
     */
    update(identifier: '1000_errors' | '500_errors' | 'basic_challenge' | 'country_challenge' | 'ip_block' | 'managed_challenge' | 'ratelimit_block' | 'under_attack' | 'waf_block' | 'waf_challenge', params: CustomPageUpdateParams, options?: Core.RequestOptions): Core.APIPromise<CustomPageUpdateResponse>;
    /**
     ...
     * ```
     */
    get(identifier: '1000_errors' | '500_errors' | 'basic_challenge' | 'country_challenge' | 'ip_block' | 'managed_challenge' | 'ratelimit_block' | 'under_attack' | 'waf_block' | 'waf_challenge', params?: CustomPageGetParams, options?: Core.RequestOptions): Core.APIPromise<CustomPageGetResponse>;
    get(identifier: '1000_errors' | '500_errors' | 'basic_challenge' | 'country_challenge' | 'ip_block' | 'managed_challenge' | 'ratelimit_block' | 'under_attack' | 'waf_block' | 'waf_challenge', options?: Core.RequestOptions): Core.APIPromise<CustomPageGetResponse>;
}
