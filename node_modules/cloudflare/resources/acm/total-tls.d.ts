...
export declare class TotalTLS extends APIResource {
     ...
     * ```
     */
    update(params: TotalTLSUpdateParams, options?: Core.RequestOptions): Core.APIPromise<TotalTLSUpdateResponse>;
    /**
     * Set Total TLS Settings or disable the feature for a Zone.
     *
     * @example
...
export declare namespace TotalTLS {
    export { type CertificateAuthority as CertificateAuthority, type TotalTLSUpdateResponse as TotalTLSUpdateResponse, type TotalTLSEditResponse as TotalTLSEditResponse, type TotalTLSGetResponse as TotalTLSGetResponse, type TotalTLSUpdateParams as TotalTLSUpdateParams, type TotalTLSEditParams as TotalTLSEditParams, type TotalTLSGetParams as TotalTLSGetParams, };
}
