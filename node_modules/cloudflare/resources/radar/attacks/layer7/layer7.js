...
class Layer7 extends resource_1.APIResource {
    constructor() {
        super(...arguments);
    ...
    summaryV2(dimension, query = {}, options) {
        ...
        return this._client.get(`/radar/attacks/layer7/summary/${dimension}`, {
            query,
            ...options,
    ...
    timeseriesGroupsV2(dimension, query = {}, options) {
        ...
        return this._client.get(`/radar/attacks/layer7/timeseries_groups/${dimension}`, {
            query,
            ...options,
        })._thenUnwrap((obj) => obj.result);
    }
...
Layer7.Summary = summary_1.Summary;
Layer7.TimeseriesGroups = timeseries_groups_1.TimeseriesGroups;
Layer7.Top = top_1.Top;
//# sourceMappingURL=layer7.js.map