...
export declare class ASPA extends APIResource {
    /**
     ...
     * ```
     */
    timeseries(query?: ASPATimeseriesParams, options?: Core.RequestOptions): Core.APIPromise<ASPATimeseriesResponse>;
...
export declare namespace ASPAChangesResponse {
    interface ASNInfo {
...
export declare namespace ASPASnapshotResponse {
    interface ASNInfo {
        '13335': ASNInfo._13335;
    }
    namespace ASNInfo {
...
export declare namespace ASPATimeseriesResponse {
    interface Meta {
        /**
         * Timestamp of the underlying data.
         */
...
export declare namespace ASPA {
    export { type ASPAChangesResponse as ASPAChangesResponse, type ASPASnapshotResponse as ASPASnapshotResponse, type ASPATimeseriesResponse as ASPATimeseriesResponse, type ASPAChangesParams as ASPAChangesParams, type ASPASnapshotParams as ASPASnapshotParams, type ASPATimeseriesParams as ASPATimeseriesParams, };
}
//# sourceMappingURL=aspa.d.ts.map