...
export declare class Policies extends APIResource {
     ...
     * ```
     */
    list(appId: string, params?: PolicyListParams, options?: Core.RequestOptions): Core.PagePromise<PolicyListResponsesV4PagePaginationArray, PolicyListResponse>;
    list(appId: string, options?: Core.RequestOptions): Core.PagePromise<PolicyListResponsesV4PagePaginationArray, PolicyListResponse>;
    /**
...
export declare class PolicyListResponsesV4PagePaginationArray extends V4PagePaginationArray<PolicyListResponse> {
}
/**
 ...
 */
export type AccessRule = GroupRule | AnyValidServiceTokenRule | AccessRule.AccessAuthContextRule | AuthenticationMethodRule | AzureGroupRule | CertificateRule | AccessRule.AccessCommonNameRule | CountryRule | AccessDevicePostureRule | DomainRule | EmailListRule | EmailRule | EveryoneRule | ExternalEvaluationRule | GitHubOrganizationRule | GSuiteGroupRule | AccessRule.AccessLoginMethodRule | IPListRule | IPRule | OktaGroupRule | SAMLGroupRule | AccessRule.AccessOIDCClaimRule | ServiceTokenRule | AccessRule.AccessLinkedAppTokenRule | AccessRule.AccessUserRiskScoreRule;
export declare namespace AccessRule {
     ...
     */
    interface AccessLinkedAppTokenRule {
        linked_app_token: AccessLinkedAppTokenRule.LinkedAppToken;
    }
    namespace AccessLinkedAppTokenRule {
        interface LinkedAppToken {
            /**
     ...
     */
    interface AccessUserRiskScoreRule {
        user_risk_score: AccessUserRiskScoreRule.UserRiskScore;
    }
    namespace AccessUserRiskScoreRule {
...
export declare namespace PolicyCreateResponse {
    /**
     * The rules that define how users may connect to targets secured by your
     * application.
     */
...
export declare namespace PolicyUpdateResponse {
    /**
     * The rules that define how users may connect to targets secured by your
     * application.
     */
...
export declare namespace PolicyListResponse {
    /**
     * The rules that define how users may connect to targets secured by your
     * application.
     */
...
export declare namespace PolicyGetResponse {
    /**
     * The rules that define how users may connect to targets secured by your
     * application.
     */
