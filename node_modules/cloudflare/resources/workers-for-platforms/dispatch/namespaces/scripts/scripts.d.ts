...
import { BindingGetParams, BindingGetResponse, BindingGetResponsesSinglePage, Bindings } from "./bindings.js";
...
import { TagDeleteParams, TagDeleteResponse, TagListParams, TagListResponse, TagListResponsesSinglePage, TagUpdateParams, TagUpdateResponse, TagUpdateResponsesSinglePage, Tags } from "./tags.js";
export declare class Scripts extends APIResource {
     ...
     * ```
     */
    delete(dispatchNamespace: string, scriptName: string, params: ScriptDeleteParams, options?: Core.RequestOptions): Core.APIPromise<ScriptDeleteResponse | null>;
    /**
...
export declare namespace Scripts {
    export { type Script as Script, type ScriptUpdateResponse as ScriptUpdateResponse, type ScriptDeleteResponse as ScriptDeleteResponse, type ScriptUpdateParams as ScriptUpdateParams, type ScriptDeleteParams as ScriptDeleteParams, type ScriptGetParams as ScriptGetParams, };
    ...
    export { Bindings as Bindings, type BindingGetResponse as BindingGetResponse, BindingGetResponsesSinglePage as BindingGetResponsesSinglePage, type BindingGetParams as BindingGetParams, };
    ...
    export { Tags as Tags, type TagUpdateResponse as TagUpdateResponse, type TagListResponse as TagListResponse, type TagDeleteResponse as TagDeleteResponse, TagUpdateResponsesSinglePage as TagUpdateResponsesSinglePage, TagListResponsesSinglePage as TagListResponsesSinglePage, type TagUpdateParams as TagUpdateParams, type TagListParams as TagListParams, type TagDeleteParams as TagDeleteParams, };
}
