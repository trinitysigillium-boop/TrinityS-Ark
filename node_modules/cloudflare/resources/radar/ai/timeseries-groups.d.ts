...
export declare class TimeseriesGroups extends APIResource {
     ...
     */
    summary(dimension: 'USER_AGENT' | 'CRAWL_PURPOSE' | 'INDUSTRY' | 'VERTICAL' | 'CONTENT_TYPE' | 'RESPONSE_STATUS' | 'RESPONSE_STATUS_CATEGORY', query?: TimeseriesGroupSummaryParams, options?: Core.RequestOptions): Core.APIPromise<TimeseriesGroupSummaryResponse>;
    summary(dimension: 'USER_AGENT' | 'CRAWL_PURPOSE' | 'INDUSTRY' | 'VERTICAL' | 'CONTENT_TYPE' | 'RESPONSE_STATUS' | 'RESPONSE_STATUS_CATEGORY', options?: Core.RequestOptions): Core.APIPromise<TimeseriesGroupSummaryResponse>;
    /**
     ...
     */
    timeseries(query?: TimeseriesGroupTimeseriesParams, options?: Core.RequestOptions): Core.APIPromise<TimeseriesGroupTimeseriesResponse>;
     ...
     */
    timeseriesGroups(dimension: 'USER_AGENT' | 'CRAWL_PURPOSE' | 'INDUSTRY' | 'VERTICAL' | 'CONTENT_TYPE' | 'RESPONSE_STATUS' | 'RESPONSE_STATUS_CATEGORY', query?: TimeseriesGroupTimeseriesGroupsParams, options?: Core.RequestOptions): Core.APIPromise<TimeseriesGroupTimeseriesGroupsResponse>;
    timeseriesGroups(dimension: 'USER_AGENT' | 'CRAWL_PURPOSE' | 'INDUSTRY' | 'VERTICAL' | 'CONTENT_TYPE' | 'RESPONSE_STATUS' | 'RESPONSE_STATUS_CATEGORY', options?: Core.RequestOptions): Core.APIPromise<TimeseriesGroupTimeseriesGroupsResponse>;
    /**
...
export declare namespace TimeseriesGroupSummaryResponse {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export interface TimeseriesGroupTimeseriesResponse {
    ...
    [k: string]: TimeseriesGroupTimeseriesResponse.unnamed_schema_ref_75bae70cf28e6bcef364b9840db3bdeb | TimeseriesGroupTimeseriesResponse.Meta | undefined;
}
export declare namespace TimeseriesGroupTimeseriesResponse {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export declare namespace TimeseriesGroupTimeseriesGroupsResponse {
    /**
     * Metadata for the results.
     */
    interface Meta {
