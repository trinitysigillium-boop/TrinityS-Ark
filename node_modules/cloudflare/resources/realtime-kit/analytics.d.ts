...
export declare class Analytics extends APIResource {
     ...
     * ```
     */
    getOrgAnalytics(appId: string, params: AnalyticsGetOrgAnalyticsParams, options?: Core.RequestOptions): Core.APIPromise<AnalyticsGetOrgAnalyticsResponse>;
}
export interface AnalyticsGetOrgAnalyticsResponse {
    data?: AnalyticsGetOrgAnalyticsResponse.Data;
    success?: boolean;
}
export declare namespace AnalyticsGetOrgAnalyticsResponse {
    interface Data {
        /**
...
export declare namespace Analytics {
    export { type AnalyticsGetOrgAnalyticsResponse as AnalyticsGetOrgAnalyticsResponse, type AnalyticsGetOrgAnalyticsParams as AnalyticsGetOrgAnalyticsParams, };
}
