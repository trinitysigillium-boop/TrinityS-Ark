...
export declare namespace BotFightModeConfiguration {
    /**
     * A read-only field that shows which unauthorized settings are currently active on
     * the zone. These settings typically result from upgrades or downgrades.
     */
...
export declare namespace SubscriptionConfiguration {
    /**
     * A read-only field that shows which unauthorized settings are currently active on
     * the zone. These settings typically result from upgrades or downgrades.
     */
...
export declare namespace SuperBotFightModeDefinitelyConfiguration {
    /**
     * A read-only field that shows which unauthorized settings are currently active on
     * the zone. These settings typically result from upgrades or downgrades.
     */
...
export declare namespace SuperBotFightModeLikelyConfiguration {
    /**
     * A read-only field that shows which unauthorized settings are currently active on
     * the zone. These settings typically result from upgrades or downgrades.
     */
