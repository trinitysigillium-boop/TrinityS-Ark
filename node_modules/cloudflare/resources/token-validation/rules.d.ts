...
export declare class Rules extends APIResource {
     ...
     * ```
     */
    list(params: RuleListParams, options?: Core.RequestOptions): Core.PagePromise<TokenValidationRulesV4PagePaginationArray, TokenValidationRule>;
    /**
     ...
     * ```
     */
    bulkCreate(params: RuleBulkCreateParams, options?: Core.RequestOptions): Core.PagePromise<TokenValidationRulesSinglePage, TokenValidationRule>;
    /**
     ...
     * ```
     */
    bulkEdit(params: RuleBulkEditParams, options?: Core.RequestOptions): Core.PagePromise<TokenValidationRulesSinglePage, TokenValidationRule>;
    /**
     ...
     * ```
     */
    edit(ruleId: string, params: RuleEditParams, options?: Core.RequestOptions): Core.APIPromise<TokenValidationRule>;
    /**
     ...
     * ```
     */
    get(ruleId: string, params: RuleGetParams, options?: Core.RequestOptions): Core.APIPromise<TokenValidationRule>;
}
export declare class TokenValidationRulesV4PagePaginationArray extends V4PagePaginationArray<TokenValidationRule> {
}
export declare class TokenValidationRulesSinglePage extends SinglePage<TokenValidationRule> {
}
/**
...
export declare namespace TokenValidationRule {
    /**
     * Select operations covered by this rule.
     *
     * For details on selectors, see the
...
export declare namespace RuleBulkEditParams {
    interface Body {
        /**
