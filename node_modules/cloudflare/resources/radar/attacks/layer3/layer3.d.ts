...
import { Summary, SummaryBitrateParams, SummaryBitrateResponse, SummaryDurationParams, SummaryDurationResponse, SummaryIPVersionParams, SummaryIPVersionResponse, SummaryIndustryParams, SummaryIndustryResponse, SummaryProtocolParams, SummaryProtocolResponse, SummaryVectorParams, SummaryVectorResponse, SummaryVerticalParams, SummaryVerticalResponse } from "./summary.js";
import * as TimeseriesGroupsAPI from "./timeseries-groups.js";
import { TimeseriesGroupBitrateParams, TimeseriesGroupBitrateResponse, TimeseriesGroupDurationParams, TimeseriesGroupDurationResponse, TimeseriesGroupIPVersionParams, TimeseriesGroupIPVersionResponse, TimeseriesGroupIndustryParams, TimeseriesGroupIndustryResponse, TimeseriesGroupProtocolParams, TimeseriesGroupProtocolResponse, TimeseriesGroupVectorParams, TimeseriesGroupVectorResponse, TimeseriesGroupVerticalParams, TimeseriesGroupVerticalResponse, TimeseriesGroups } from "./timeseries-groups.js";
...
export declare class Layer3 extends APIResource {
     ...
     * ```
     */
    summaryV2(dimension: 'PROTOCOL' | 'IP_VERSION' | 'VECTOR' | 'DURATION' | 'BITRATE' | 'VERTICAL' | 'INDUSTRY', query?: Layer3SummaryV2Params, options?: Core.RequestOptions): Core.APIPromise<Layer3SummaryV2Response>;
    summaryV2(dimension: 'PROTOCOL' | 'IP_VERSION' | 'VECTOR' | 'DURATION' | 'BITRATE' | 'VERTICAL' | 'INDUSTRY', options?: Core.RequestOptions): Core.APIPromise<Layer3SummaryV2Response>;
    /**
     ...
     * ```
     */
    timeseriesGroupsV2(dimension: 'PROTOCOL' | 'IP_VERSION' | 'VECTOR' | 'DURATION' | 'BITRATE' | 'VERTICAL' | 'INDUSTRY', query?: Layer3TimeseriesGroupsV2Params, options?: Core.RequestOptions): Core.APIPromise<Layer3TimeseriesGroupsV2Response>;
    timeseriesGroupsV2(dimension: 'PROTOCOL' | 'IP_VERSION' | 'VECTOR' | 'DURATION' | 'BITRATE' | 'VERTICAL' | 'INDUSTRY', options?: Core.RequestOptions): Core.APIPromise<Layer3TimeseriesGroupsV2Response>;
}
...
export declare namespace Layer3SummaryV2Response {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export interface Layer3TimeseriesResponse {
    ...
    [k: string]: Layer3TimeseriesResponse.unnamed_schema_ref_75bae70cf28e6bcef364b9840db3bdeb | Layer3TimeseriesResponse.Meta | undefined;
}
...
export declare namespace Layer3TimeseriesGroupsV2Response {
    /**
     * Metadata for the results.
     */
    interface Meta {
