...
export declare class HTTP extends APIResource {
     ...
     * ```
     */
    summaryV2(dimension: 'ADM1' | 'API_TRAFFIC' | 'AS' | 'BOT_CLASS' | 'BROWSER' | 'BROWSER_FAMILY' | 'DEVICE_TYPE' | 'HTTP_PROTOCOL' | 'HTTP_VERSION' | 'IP_VERSION' | 'LOCATION' | 'OS' | 'POST_QUANTUM' | 'TLS_VERSION', query?: HTTPSummaryV2Params, options?: Core.RequestOptions): Core.APIPromise<HTTPSummaryV2Response>;
    summaryV2(dimension: 'ADM1' | 'API_TRAFFIC' | 'AS' | 'BOT_CLASS' | 'BROWSER' | 'BROWSER_FAMILY' | 'DEVICE_TYPE' | 'HTTP_PROTOCOL' | 'HTTP_VERSION' | 'IP_VERSION' | 'LOCATION' | 'OS' | 'POST_QUANTUM' | 'TLS_VERSION', options?: Core.RequestOptions): Core.APIPromise<HTTPSummaryV2Response>;
    /**
     ...
     * ```
     */
    timeseriesGroupsV2(dimension: 'ADM1' | 'API_TRAFFIC' | 'AS' | 'BOT_CLASS' | 'BROWSER' | 'BROWSER_FAMILY' | 'DEVICE_TYPE' | 'HTTP_PROTOCOL' | 'HTTP_VERSION' | 'IP_VERSION' | 'LOCATION' | 'OS' | 'POST_QUANTUM' | 'TLS_VERSION', query?: HTTPTimeseriesGroupsV2Params, options?: Core.RequestOptions): Core.APIPromise<HTTPTimeseriesGroupsV2Response>;
    timeseriesGroupsV2(dimension: 'ADM1' | 'API_TRAFFIC' | 'AS' | 'BOT_CLASS' | 'BROWSER' | 'BROWSER_FAMILY' | 'DEVICE_TYPE' | 'HTTP_PROTOCOL' | 'HTTP_VERSION' | 'IP_VERSION' | 'LOCATION' | 'OS' | 'POST_QUANTUM' | 'TLS_VERSION', options?: Core.RequestOptions): Core.APIPromise<HTTPTimeseriesGroupsV2Response>;
}
...
export declare namespace HTTPSummaryV2Response {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export interface HTTPTimeseriesResponse {
    ...
    [k: string]: HTTPTimeseriesResponse.unnamed_schema_ref_75bae70cf28e6bcef364b9840db3bdeb | HTTPTimeseriesResponse.Meta | undefined;
}
...
export declare namespace HTTPTimeseriesGroupsV2Response {
    /**
     * Metadata for the results.
     */
    interface Meta {
