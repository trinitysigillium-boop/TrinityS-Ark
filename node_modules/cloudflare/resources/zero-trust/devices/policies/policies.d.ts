...
import { Custom, CustomCreateParams, CustomDeleteParams, CustomEditParams, CustomGetParams, CustomListParams } from "./custom/custom.js";
...
export type SplitTunnelExclude = SplitTunnelExclude.TeamsDevicesExcludeSplitTunnelWithAddress | SplitTunnelExclude.TeamsDevicesExcludeSplitTunnelWithHost;
export declare namespace SplitTunnelExclude {
    interface TeamsDevicesExcludeSplitTunnelWithAddress {
        /**
...
export type SplitTunnelExcludeParam = SplitTunnelExcludeParam.TeamsDevicesExcludeSplitTunnelWithAddress | SplitTunnelExcludeParam.TeamsDevicesExcludeSplitTunnelWithHost;
export declare namespace SplitTunnelExcludeParam {
    interface TeamsDevicesExcludeSplitTunnelWithAddress {
        /**
         * The address in CIDR format to exclude from the tunnel. If `address` is present,
         * `host` must not be present.
...
export type SplitTunnelInclude = SplitTunnelInclude.TeamsDevicesIncludeSplitTunnelWithAddress | SplitTunnelInclude.TeamsDevicesIncludeSplitTunnelWithHost;
export declare namespace SplitTunnelInclude {
    interface TeamsDevicesIncludeSplitTunnelWithAddress {
        /**
    ...
    interface TeamsDevicesIncludeSplitTunnelWithHost {
        /**
...
export type SplitTunnelIncludeParam = SplitTunnelIncludeParam.TeamsDevicesIncludeSplitTunnelWithAddress | SplitTunnelIncludeParam.TeamsDevicesIncludeSplitTunnelWithHost;
export declare namespace SplitTunnelIncludeParam {
    interface TeamsDevicesIncludeSplitTunnelWithAddress {
        /**
         * The address in CIDR format to include in the tunnel. If `address` is present,
         * `host` must not be present.
...
export declare namespace Policies {
    ...
    export { Custom as Custom, type CustomCreateParams as CustomCreateParams, type CustomListParams as CustomListParams, type CustomDeleteParams as CustomDeleteParams, type CustomEditParams as CustomEditParams, type CustomGetParams as CustomGetParams, };
}
