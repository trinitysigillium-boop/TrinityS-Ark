...
export declare class Audit extends APIResource {
    /**
     * Gets a list of audit logs for an organization.
     */
    list(organizationId: string, query: AuditListParams, options?: Core.RequestOptions): Core.PagePromise<AuditListResponsesCursorPaginationAfter, AuditListResponse>;
}
export declare class AuditListResponsesCursorPaginationAfter extends CursorPaginationAfter<AuditListResponse> {
}
...
export declare namespace AuditListResponse {
    /**
     * Provides information about the action performed.
     */
    interface Action {
...
export declare namespace AuditListParams {
    interface ID {
        /**
...
export declare namespace Audit {
    export { type AuditListResponse as AuditListResponse, AuditListResponsesCursorPaginationAfter as AuditListResponsesCursorPaginationAfter, type AuditListParams as AuditListParams, };
}
