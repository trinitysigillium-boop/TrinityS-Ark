...
export declare class Security extends APIResource {
     ...
     * ```
     */
    summaryV2(dimension: 'SPAM' | 'MALICIOUS' | 'SPOOF' | 'THREAT_CATEGORY' | 'ARC' | 'DKIM' | 'DMARC' | 'SPF' | 'TLS_VERSION', query?: SecuritySummaryV2Params, options?: Core.RequestOptions): Core.APIPromise<SecuritySummaryV2Response>;
    summaryV2(dimension: 'SPAM' | 'MALICIOUS' | 'SPOOF' | 'THREAT_CATEGORY' | 'ARC' | 'DKIM' | 'DMARC' | 'SPF' | 'TLS_VERSION', options?: Core.RequestOptions): Core.APIPromise<SecuritySummaryV2Response>;
    /**
     ...
     * ```
     */
    timeseriesGroupsV2(dimension: 'SPAM' | 'MALICIOUS' | 'SPOOF' | 'THREAT_CATEGORY' | 'ARC' | 'DKIM' | 'DMARC' | 'SPF' | 'TLS_VERSION', query?: SecurityTimeseriesGroupsV2Params, options?: Core.RequestOptions): Core.APIPromise<SecurityTimeseriesGroupsV2Response>;
    timeseriesGroupsV2(dimension: 'SPAM' | 'MALICIOUS' | 'SPOOF' | 'THREAT_CATEGORY' | 'ARC' | 'DKIM' | 'DMARC' | 'SPF' | 'TLS_VERSION', options?: Core.RequestOptions): Core.APIPromise<SecurityTimeseriesGroupsV2Response>;
}
...
export declare namespace SecuritySummaryV2Response {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export declare namespace SecurityTimeseriesGroupsV2Response {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export declare namespace Security {
    export { type SecuritySummaryV2Response as SecuritySummaryV2Response, type SecurityTimeseriesGroupsV2Response as SecurityTimeseriesGroupsV2Response, type SecuritySummaryV2Params as SecuritySummaryV2Params, type SecurityTimeseriesGroupsV2Params as SecurityTimeseriesGroupsV2Params, };
    export { Top as Top };
