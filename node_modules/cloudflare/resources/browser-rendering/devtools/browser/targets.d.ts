...
export declare class Targets extends APIResource {
     ...
     * ```
     */
    create(sessionId: string, params: TargetCreateParams, options?: Core.RequestOptions): Core.APIPromise<TargetCreateResponse>;
    /**
     ...
     * ```
     */
    list(sessionId: string, params: TargetListParams, options?: Core.RequestOptions): Core.APIPromise<TargetListResponse>;
    /**
     ...
     * ```
     */
    activate(sessionId: string, targetId: string, params: TargetActivateParams, options?: Core.RequestOptions): Core.APIPromise<TargetActivateResponse>;
    /**
     ...
     * ```
     */
    close(sessionId: string, targetId: string, params: TargetCloseParams, options?: Core.RequestOptions): Core.APIPromise<TargetCloseResponse>;
    /**
     ...
     * ```
     */
    get(sessionId: string, targetId: string, params: TargetGetParams, options?: Core.RequestOptions): Core.APIPromise<TargetGetResponse>;
}
