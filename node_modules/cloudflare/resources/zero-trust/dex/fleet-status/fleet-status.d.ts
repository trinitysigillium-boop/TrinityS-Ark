...
export declare class FleetStatus extends APIResource {
     ...
     * ```
     */
    overTime(params: FleetStatusOverTimeParams, options?: Core.RequestOptions): Core.APIPromise<FleetStatusOverTimeResponse>;
}
...
export declare namespace FleetStatusOverTimeResponse {
    interface DeviceStats {
...
export declare namespace FleetStatus {
    export { type LiveStat as LiveStat, type FleetStatusLiveResponse as FleetStatusLiveResponse, type FleetStatusOverTimeResponse as FleetStatusOverTimeResponse, type FleetStatusLiveParams as FleetStatusLiveParams, type FleetStatusOverTimeParams as FleetStatusOverTimeParams, };
