...
import * as TimeTravelAPI from "./time-travel.js";
import { TimeTravel, TimeTravelGetBookmarkParams, TimeTravelGetBookmarkResponse, TimeTravelRestoreParams, TimeTravelRestoreResponse } from "./time-travel.js";
...
export declare class Database extends APIResource {
    timeTravel: TimeTravelAPI.TimeTravel;
    /**
     ...
     * ```
     */
    update(databaseId: string, params: DatabaseUpdateParams, options?: Core.RequestOptions): Core.APIPromise<D1API.D1>;
    /**
     ...
     * ```
     */
    edit(databaseId: string, params: DatabaseEditParams, options?: Core.RequestOptions): Core.APIPromise<D1API.D1>;
    /**
...
export declare namespace DatabaseCreateParams {
    /**
...
export declare namespace DatabaseUpdateParams {
    /**
     * Configuration for D1 read replication.
     */
    interface ReadReplication {
...
export declare namespace DatabaseEditParams {
    /**
     * Configuration for D1 read replication.
     */
    interface ReadReplication {
...
export type DatabaseImportParams = DatabaseImportParams.Init | DatabaseImportParams.Ingest | DatabaseImportParams.Poll;
...
export declare namespace Database {
    ...
    export { TimeTravel as TimeTravel, type TimeTravelGetBookmarkResponse as TimeTravelGetBookmarkResponse, type TimeTravelRestoreResponse as TimeTravelRestoreResponse, type TimeTravelGetBookmarkParams as TimeTravelGetBookmarkParams, type TimeTravelRestoreParams as TimeTravelRestoreParams, };
}
