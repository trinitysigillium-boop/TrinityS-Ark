...
import * as RegistrationStatusAPI from "./registration-status.mjs";
import { RegistrationStatus } from "./registration-status.mjs";
import * as UpdateStatusAPI from "./update-status.mjs";
