...
export declare class TrustedDomains extends APIResource {
     ...
     * ```
     */
    delete(trustedDomainId: string, params: TrustedDomainDeleteParams, options?: Core.RequestOptions): Core.APIPromise<TrustedDomainDeleteResponse>;
    /**
     ...
     * ```
     */
    edit(trustedDomainId: string, params: TrustedDomainEditParams, options?: Core.RequestOptions): Core.APIPromise<TrustedDomainEditResponse>;
    /**
     ...
     * ```
     */
    get(trustedDomainId: string, params: TrustedDomainGetParams, options?: Core.RequestOptions): Core.APIPromise<TrustedDomainGetResponse>;
}
