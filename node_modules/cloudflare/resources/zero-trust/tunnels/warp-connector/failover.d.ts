...
export declare class Failover extends APIResource {
    /**
     ...
     * ```
     */
    update(tunnelId: string, params: FailoverUpdateParams, options?: Core.RequestOptions): Core.APIPromise<FailoverUpdateResponse | null>;
}
...
export declare namespace Failover {
    export { type FailoverUpdateResponse as FailoverUpdateResponse, type FailoverUpdateParams as FailoverUpdateParams, };
}
