...
export declare namespace ResourceSharingCreateResponse {
    interface Resource {
        /**
         ...
         * Resource Type.
         */
        resource_type: 'custom-ruleset' | 'gateway-policy' | 'gateway-destination-ip' | 'gateway-block-page-settings' | 'gateway-extended-email-matching' | 'idp-federation-grant';
        /**
         * Resource Version.
         */
...
export declare namespace ResourceSharingUpdateResponse {
    interface Resource {
        /**
         * Share Resource identifier.
         */
...
export declare namespace ResourceSharingListResponse {
    interface Resource {
        /**
         * Share Resource identifier.
         */
...
export declare namespace ResourceSharingDeleteResponse {
    interface Resource {
        /**
         * Share Resource identifier.
         */
...
export declare namespace ResourceSharingGetResponse {
    interface Resource {
        /**
         * Share Resource identifier.
         */
...
export interface ResourceSharingListParams extends V4PagePaginationArrayParams {
     ...
     */
    resource_types?: Array<'custom-ruleset' | 'gateway-policy' | 'gateway-destination-ip' | 'gateway-block-page-settings' | 'gateway-extended-email-matching' | 'idp-federation-grant'>;
    /**
