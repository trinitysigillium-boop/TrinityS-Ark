...
const MarkdownForAgentsAPI = __importStar(require("./markdown-for-agents.js"));
const markdown_for_agents_1 = require("./markdown-for-agents.js");
...
class AI extends resource_1.APIResource {
    constructor() {
        ...
        this.markdownForAgents = new MarkdownForAgentsAPI.MarkdownForAgents(this._client);
    }
}
exports.AI = AI;
...
AI.MarkdownForAgents = markdown_for_agents_1.MarkdownForAgents;
