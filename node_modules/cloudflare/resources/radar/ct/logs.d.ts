    ...
    namespace CertificateLog {
        ...
        namespace Performance {
            interface Endpoint {
                 ...
                 */
                endpoint: 'add-chain (new)' | 'add-chain (old)' | 'add-pre-chain (new)' | 'add-pre-chain (old)' | 'get-entries' | 'get-roots' | 'get-sth';
                responseTime: number;
                uptime: number;
            }
        }
...
export declare namespace Logs {
    export { type LogListResponse as LogListResponse, type LogGetResponse as LogGetResponse, type LogListParams as LogListParams, type LogGetParams as LogGetParams, };
}
