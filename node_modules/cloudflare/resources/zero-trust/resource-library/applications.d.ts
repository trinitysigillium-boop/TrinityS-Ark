...
export declare class Applications extends APIResource {
     ...
     * ```
     */
    get(id: string, params: ApplicationGetParams, options?: Core.RequestOptions): Core.APIPromise<ApplicationGetResponse>;
}
...
export declare namespace Applications {
    export { type ApplicationListResponse as ApplicationListResponse, type ApplicationGetResponse as ApplicationGetResponse, ApplicationListResponsesSinglePage as ApplicationListResponsesSinglePage, type ApplicationListParams as ApplicationListParams, type ApplicationGetParams as ApplicationGetParams, };
}
