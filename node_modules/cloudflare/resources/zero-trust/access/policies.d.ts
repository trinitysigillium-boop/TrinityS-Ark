...
import * as ApplicationsPoliciesAPI from "./applications/policies.js";
...
export declare class Policies extends APIResource {
     ...
     * ```
     */
    list(params: PolicyListParams, options?: Core.RequestOptions): Core.PagePromise<PolicyListResponsesV4PagePaginationArray, PolicyListResponse>;
    /**
