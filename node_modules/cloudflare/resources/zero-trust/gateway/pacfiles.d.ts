...
export declare class Pacfiles extends APIResource {
    /**
     ...
     * ```
     */
    update(pacfileId: string, params: PacfileUpdateParams, options?: Core.RequestOptions): Core.APIPromise<PacfileUpdateResponse>;
    /**
     ...
     * ```
     */
    list(params: PacfileListParams, options?: Core.RequestOptions): Core.PagePromise<PacfileListResponsesSinglePage, PacfileListResponse>;
    /**
     ...
     * ```
     */
    delete(pacfileId: string, params: PacfileDeleteParams, options?: Core.RequestOptions): Core.APIPromise<PacfileDeleteResponse>;
    /**
     ...
     * ```
     */
    get(pacfileId: string, params: PacfileGetParams, options?: Core.RequestOptions): Core.APIPromise<PacfileGetResponse>;
}
export declare class PacfileListResponsesSinglePage extends SinglePage<PacfileListResponse> {
}
