...
export declare class Fraud extends APIResource {
    /**
...
export declare namespace FraudSettings {
    /**
     * Configuration for classifying login authentication outcomes based on the origin
     * response. Requires `user_profiles` to be enabled.
     *
    ...
    namespace AuthenticationSettings {
        /**
         * Criterion for identifying failed login responses.
         */
...
export declare namespace FraudUpdateParams {
    /**
     * Configuration for classifying login authentication outcomes based on the origin
     * response. Requires `user_profiles` to be enabled.
     *
...
export declare namespace Fraud {
    export { type FraudSettings as FraudSettings, type FraudUpdateParams as FraudUpdateParams, type FraudGetParams as FraudGetParams, };
}
