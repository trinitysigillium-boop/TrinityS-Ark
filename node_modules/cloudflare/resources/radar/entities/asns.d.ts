...
export declare class ASNs extends APIResource {
     ...
     * ```
     */
    asSet(asn: number, query?: ASNAsSetParams, options?: Core.RequestOptions): Core.APIPromise<ASNAsSetResponse>;
     ...
     * ```
     */
    botnetThreatFeed(query?: ASNBotnetThreatFeedParams, options?: Core.RequestOptions): Core.APIPromise<ASNBotnetThreatFeedResponse>;
...
export declare namespace ASNAsSetResponse {
    interface AsSet {
        /**
...
export declare namespace ASNBotnetThreatFeedResponse {
    interface Ase {
        asn: number;
        country: string;
        name: string;
...
export declare namespace ASNs {
    export { type ASNListResponse as ASNListResponse, type ASNAsSetResponse as ASNAsSetResponse, type ASNBotnetThreatFeedResponse as ASNBotnetThreatFeedResponse, type ASNGetResponse as ASNGetResponse, type ASNIPResponse as ASNIPResponse, type ASNRelResponse as ASNRelResponse, type ASNListParams as ASNListParams, type ASNAsSetParams as ASNAsSetParams, type ASNBotnetThreatFeedParams as ASNBotnetThreatFeedParams, type ASNGetParams as ASNGetParams, type ASNIPParams as ASNIPParams, type ASNRelParams as ASNRelParams, };
}
