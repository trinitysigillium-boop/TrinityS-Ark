...
import { CustomPage, CustomPageCreateParams, CustomPageDeleteParams, CustomPageDeleteResponse, CustomPageGetParams, CustomPageListParams, CustomPageUpdateParams, CustomPageWithoutHTML, CustomPageWithoutHTMLsV4PagePaginationArray, CustomPages } from "./custom-pages.js";
...
import { GroupCreateParams, GroupCreateResponse, GroupDeleteParams, GroupDeleteResponse, GroupGetParams, GroupGetResponse, GroupListParams, GroupListResponse, GroupListResponsesV4PagePaginationArray, GroupUpdateParams, GroupUpdateResponse, Groups, ZeroTrustGroup } from "./groups.js";
...
import { ApprovalGroup, Policies, Policy, PolicyCreateParams, PolicyCreateResponse, PolicyDeleteParams, PolicyDeleteResponse, PolicyGetParams, PolicyGetResponse, PolicyListParams, PolicyListResponse, PolicyListResponsesV4PagePaginationArray, PolicyUpdateParams, PolicyUpdateResponse } from "./policies.js";
import * as ServiceTokensAPI from "./service-tokens.js";
import { ServiceToken, ServiceTokenCreateParams, ServiceTokenCreateResponse, ServiceTokenDeleteParams, ServiceTokenGetParams, ServiceTokenListParams, ServiceTokenRefreshParams, ServiceTokenRotateParams, ServiceTokenRotateResponse, ServiceTokenUpdateParams, ServiceTokens, ServiceTokensV4PagePaginationArray } from "./service-tokens.js";
import * as TagsAPI from "./tags.js";
import { Tag, TagCreateParams, TagDeleteParams, TagDeleteResponse, TagGetParams, TagListParams, TagUpdateParams, Tags, TagsV4PagePaginationArray } from "./tags.js";
import * as AIControlsAPI from "./ai-controls/ai-controls.js";
import { AIControls } from "./ai-controls/ai-controls.js";
import * as ApplicationsAPI from "./applications/applications.js";
import { AllowedHeaders, AllowedIdPs, AllowedMethods, AllowedOrigins, AppID, Application, ApplicationCreateParams, ApplicationCreateResponse, ApplicationDeleteParams, ApplicationDeleteResponse, ApplicationGetParams, ApplicationGetResponse, ApplicationListParams, ApplicationListResponse, ApplicationListResponsesV4PagePaginationArray, ApplicationPolicy, ApplicationRevokeTokensParams, ApplicationRevokeTokensResponse, ApplicationSCIMConfig, ApplicationType, ApplicationUpdateParams, ApplicationUpdateResponse, Applications, CORSHeaders, Decision, OIDCSaaSApp, SAMLSaaSApp, SCIMConfigAuthenticationHTTPBasic, SCIMConfigAuthenticationOAuthBearerToken, SCIMConfigAuthenticationOauth2, SCIMConfigMapping, SaaSAppNameIDFormat, SelfHostedDomains } from "./applications/applications.js";
import * as CertificatesAPI from "./certificates/certificates.js";
import { AssociatedHostnames, Certificate, CertificateCreateParams, CertificateDeleteParams, CertificateDeleteResponse, CertificateGetParams, CertificateListParams, CertificateUpdateParams, Certificates, CertificatesV4PagePaginationArray } from "./certificates/certificates.js";
...
import { AccessUser, UserCreateParams, UserCreateResponse, UserDeleteParams, UserDeleteResponse, UserGetParams, UserGetResponse, UserListParams, UserListResponse, UserListResponsesV4PagePaginationArray, UserUpdateParams, UserUpdateResponse, Users } from "./users/users.js";
export declare class Access extends APIResource {
    aiControls: AIControlsAPI.AIControls;
...
export declare namespace Access {
    ...
    export { Logs as Logs };
    export { Users as Users, type AccessUser as AccessUser, type UserCreateResponse as UserCreateResponse, type UserUpdateResponse as UserUpdateResponse, type UserListResponse as UserListResponse, type UserDeleteResponse as UserDeleteResponse, type UserGetResponse as UserGetResponse, UserListResponsesV4PagePaginationArray as UserListResponsesV4PagePaginationArray, type UserCreateParams as UserCreateParams, type UserUpdateParams as UserUpdateParams, type UserListParams as UserListParams, type UserDeleteParams as UserDeleteParams, type UserGetParams as UserGetParams, };
    ...
    export { Tags as Tags, type Tag as Tag, type TagDeleteResponse as TagDeleteResponse, TagsV4PagePaginationArray as TagsV4PagePaginationArray, type TagCreateParams as TagCreateParams, type TagUpdateParams as TagUpdateParams, type TagListParams as TagListParams, type TagDeleteParams as TagDeleteParams, type TagGetParams as TagGetParams, };
    export { Policies as Policies, type ApprovalGroup as ApprovalGroup, type Policy as Policy, type PolicyCreateResponse as PolicyCreateResponse, type PolicyUpdateResponse as PolicyUpdateResponse, type PolicyListResponse as PolicyListResponse, type PolicyDeleteResponse as PolicyDeleteResponse, type PolicyGetResponse as PolicyGetResponse, PolicyListResponsesV4PagePaginationArray as PolicyListResponsesV4PagePaginationArray, type PolicyCreateParams as PolicyCreateParams, type PolicyUpdateParams as PolicyUpdateParams, type PolicyListParams as PolicyListParams, type PolicyDeleteParams as PolicyDeleteParams, type PolicyGetParams as PolicyGetParams, };
}
