...
export type Record = ARecord | AAAARecord | CNAMERecord | MXRecord | NSRecord | Record.Openpgpkey | PTRRecord | TXTRecord | CAARecord | CERTRecord | DNSKEYRecord | DSRecord | HTTPSRecord | LOCRecord | NAPTRRecord | SMIMEARecord | SRVRecord | SSHFPRecord | SVCBRecord | TLSARecord | URIRecord;
...
export declare namespace RecordScanTriggerResponse {
    interface Error {
        code: number;
        message: string;
...
export type RecordCreateParams = RecordCreateParams.ARecord | RecordCreateParams.AAAARecord | RecordCreateParams.CNAMERecord | RecordCreateParams.MXRecord | RecordCreateParams.NSRecord | RecordCreateParams.DNSRecordsOpenpgpkeyRecord | RecordCreateParams.PTRRecord | RecordCreateParams.TXTRecord | RecordCreateParams.CAARecord | RecordCreateParams.CERTRecord | RecordCreateParams.DNSKEYRecord | RecordCreateParams.DSRecord | RecordCreateParams.HTTPSRecord | RecordCreateParams.LOCRecord | RecordCreateParams.NAPTRRecord | RecordCreateParams.SMIMEARecord | RecordCreateParams.SRVRecord | RecordCreateParams.SSHFPRecord | RecordCreateParams.SVCBRecord | RecordCreateParams.TLSARecord | RecordCreateParams.URIRecord;
...
export type RecordUpdateParams = RecordUpdateParams.ARecord | RecordUpdateParams.AAAARecord | RecordUpdateParams.CNAMERecord | RecordUpdateParams.MXRecord | RecordUpdateParams.NSRecord | RecordUpdateParams.DNSRecordsOpenpgpkeyRecord | RecordUpdateParams.PTRRecord | RecordUpdateParams.TXTRecord | RecordUpdateParams.CAARecord | RecordUpdateParams.CERTRecord | RecordUpdateParams.DNSKEYRecord | RecordUpdateParams.DSRecord | RecordUpdateParams.HTTPSRecord | RecordUpdateParams.LOCRecord | RecordUpdateParams.NAPTRRecord | RecordUpdateParams.SMIMEARecord | RecordUpdateParams.SRVRecord | RecordUpdateParams.SSHFPRecord | RecordUpdateParams.SVCBRecord | RecordUpdateParams.TLSARecord | RecordUpdateParams.URIRecord;
...
export interface RecordBatchParams {
     ...
     * Body param
     */
    posts?: Array<ARecordParam | AAAARecordParam | CNAMERecordParam | MXRecordParam | NSRecordParam | RecordBatchParams.DNSRecordsOpenpgpkeyRecord | PTRRecordParam | TXTRecordParam | CAARecordParam | CERTRecordParam | DNSKEYRecordParam | DSRecordParam | HTTPSRecordParam | LOCRecordParam | NAPTRRecordParam | SMIMEARecordParam | SRVRecordParam | SSHFPRecordParam | SVCBRecordParam | TLSARecordParam | URIRecordParam>;
    /**
     * Body param
     */
...
export interface RecordScanReviewParams {
     ...
     * Body param
     */
    accepts?: Array<ARecordParam | AAAARecordParam | CNAMERecordParam | MXRecordParam | NSRecordParam | RecordScanReviewParams.DNSRecordsOpenpgpkeyRecord | PTRRecordParam | TXTRecordParam | CAARecordParam | CERTRecordParam | DNSKEYRecordParam | DSRecordParam | HTTPSRecordParam | LOCRecordParam | NAPTRRecordParam | SMIMEARecordParam | SRVRecordParam | SSHFPRecordParam | SVCBRecordParam | TLSARecordParam | URIRecordParam>;
    /**
     * Body param
     */
    rejects?: Array<RecordScanReviewParams.Reject>;
}
export declare namespace RecordScanReviewParams {
    interface DNSRecordsOpenpgpkeyRecord {
        /**
         * Complete DNS record name, including the zone name, in Punycode.
         */
