...
export declare class Health extends APIResource {
     ...
     * ```
     */
    create(poolId: string, params: HealthCreateParams, options?: Core.RequestOptions): Core.APIPromise<HealthCreateResponse>;
    /**
     ...
     * ```
     */
    get(poolId: string, params: HealthGetParams, options?: Core.RequestOptions): Core.APIPromise<HealthGetResponse>;
}
...
export declare namespace Health {
    export { type HealthCreateResponse as HealthCreateResponse, type HealthGetResponse as HealthGetResponse, type HealthCreateParams as HealthCreateParams, type HealthGetParams as HealthGetParams, };
}
