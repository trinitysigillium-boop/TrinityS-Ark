...
export declare class Filters extends APIResource {
     ...
     * @deprecated The Filters API is deprecated in favour of using the Ruleset Engine. See https://developers.cloudflare.com/fundamentals/api/reference/deprecations/#firewall-rules-api-and-filters-api for full details.
     */
    delete(filterId: string, params: FilterDeleteParams, options?: Core.RequestOptions): Core.APIPromise<FilterDeleteResponse>;
    /**
...
export declare namespace FilterBulkDeleteResponse {
    interface FilterBulkDeleteResponseItem {
        /**
         * The unique identifier of the filter.
         */
        id?: string;
...
export declare namespace FilterBulkUpdateParams {
    interface Body {
        /**
         * An informative summary of the filter.
         */
