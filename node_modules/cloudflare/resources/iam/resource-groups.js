...
exports.ResourceGroupListResponsesSinglePage = exports.ResourceGroups = void 0;
...
class ResourceGroups extends resource_1.APIResource {
    ...
    create(params, options) {
        ...
        return this._client.post(`/accounts/${account_id}/iam/resource_groups`, {
            body,
            ...options,
    ...
    get(resourceGroupId, params, options) {
        const { account_id } = params;
        return this._client.get(`/accounts/${account_id}/iam/resource_groups/${resourceGroupId}`, options)._thenUnwrap((obj) => obj.result);
    }
}
exports.ResourceGroups = ResourceGroups;
class ResourceGroupListResponsesSinglePage extends pagination_1.SinglePage {
}
exports.ResourceGroupListResponsesSinglePage = ResourceGroupListResponsesSinglePage;
