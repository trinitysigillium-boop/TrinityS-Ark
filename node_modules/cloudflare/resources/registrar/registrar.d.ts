...
import { Domain as DomainsAPIDomain, DomainGetParams, DomainGetResponse, DomainListParams, DomainUpdateParams, DomainUpdateResponse, Domains, DomainsSinglePage } from "./domains.js";
import * as RegistrationStatusAPI from "./registration-status.js";
import { RegistrationStatus, RegistrationStatusGetParams } from "./registration-status.js";
import * as UpdateStatusAPI from "./update-status.js";
import { UpdateStatus, UpdateStatusGetParams } from "./update-status.js";
export declare class Registrar extends APIResource {
    domains: DomainsAPI.Domains;
    registrationStatus: RegistrationStatusAPI.RegistrationStatus;
    updateStatus: UpdateStatusAPI.UpdateStatus;
    /**
     ...
     * ```
     */
    check(params: RegistrarCheckParams, options?: Core.RequestOptions): Core.APIPromise<RegistrarCheckResponse>;
    /**
     ...
     * ```
     */
    search(params: RegistrarSearchParams, options?: Core.RequestOptions): Core.APIPromise<RegistrarSearchResponse>;
}
/**
...
export interface Registration {
     ...
     */
    status: 'active' | 'registration_pending' | 'expired' | 'suspended' | 'redemption_period' | 'pending_delete';
}
/**
...
export declare namespace RegistrarCheckResponse {
    /**
    ...
    interface Domain {
         ...
         */
        reason?: 'extension_not_supported_via_api' | 'extension_not_supported' | 'extension_disallows_registration' | 'domain_premium' | 'domain_unavailable';
        /**
...
export declare namespace RegistrarSearchResponse {
    /**
...
export declare namespace Registrar {
    export { type Registration as Registration, type WorkflowStatus as WorkflowStatus, type RegistrarCheckResponse as RegistrarCheckResponse, type RegistrarSearchResponse as RegistrarSearchResponse, type RegistrarCheckParams as RegistrarCheckParams, type RegistrarSearchParams as RegistrarSearchParams, };
    export { Domains as Domains, type DomainsAPIDomain as Domain, type DomainUpdateResponse as DomainUpdateResponse, type DomainGetResponse as DomainGetResponse, DomainsSinglePage as DomainsSinglePage, type DomainUpdateParams as DomainUpdateParams, type DomainListParams as DomainListParams, type DomainGetParams as DomainGetParams, };
    export { RegistrationStatus as RegistrationStatus, type RegistrationStatusGetParams as RegistrationStatusGetParams, };
