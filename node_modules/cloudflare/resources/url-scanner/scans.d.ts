        ...
        namespace Processors {
            ...
            namespace AgentReadiness {
                ...
                namespace Checks {
                    ...
                    namespace ContentAccessibility {
                        interface MarkdownNegotiation {
                            status: string;
                            details?: unknown;
                            durationMs?: number;
                    ...
                    namespace Discovery {
                        ...
                        namespace OAuthProtectedResource {
                            interface Evidence {
                                action: string;
                                label: string;
                                finding?: Evidence.Finding;
