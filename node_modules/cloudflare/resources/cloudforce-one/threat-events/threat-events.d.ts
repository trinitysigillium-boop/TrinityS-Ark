...
export declare namespace ThreatEventBulkCreateResponse {
...
export declare namespace ThreatEventEditParams {
    interface Raw {
        data?: {
            [key: string]: unknown;
        } | null;
