...
export declare class Items extends APIResource {
     ...
     * ```
     */
    delete(filterId: string, params: ItemDeleteParams, options?: Core.RequestOptions): Core.APIPromise<ItemDeleteResponse>;
    /**
     ...
     * ```
     */
    edit(filterId: string, params: ItemEditParams, options?: Core.RequestOptions): Core.APIPromise<ItemEditResponse>;
    /**
     ...
     * ```
     */
    get(filterId: string, params: ItemGetParams, options?: Core.RequestOptions): Core.APIPromise<ItemGetResponse>;
}
...
export declare namespace ItemDeleteResponse {
    interface Error {
        code: number;
        message: string;
...
export declare namespace Items {
    export { type ItemDeleteResponse as ItemDeleteResponse, type ItemEditResponse as ItemEditResponse, type ItemGetResponse as ItemGetResponse, type ItemDeleteParams as ItemDeleteParams, type ItemEditParams as ItemEditParams, type ItemGetParams as ItemGetParams, };
}
