...
const AgentReadinessAPI = __importStar(require("./agent-readiness.js"));
const agent_readiness_1 = require("./agent-readiness.js");
const DatasetsAPI = __importStar(require("./datasets.js"));
const datasets_1 = require("./datasets.js");
const GeolocationsAPI = __importStar(require("./geolocations.js"));
const geolocations_1 = require("./geolocations.js");
...
const CTAPI = __importStar(require("./ct/ct.js"));
const ct_1 = require("./ct/ct.js");
...
const PostQuantumAPI = __importStar(require("./post-quantum/post-quantum.js"));
const post_quantum_1 = require("./post-quantum/post-quantum.js");
...
class Radar extends resource_1.APIResource {
    constructor() {
        super(...arguments);
        this.agentReadiness = new AgentReadinessAPI.AgentReadiness(this._client);
        ...
        this.postQuantum = new PostQuantumAPI.PostQuantum(this._client);
        ...
        this.geolocations = new GeolocationsAPI.Geolocations(this._client);
...
exports.Radar = Radar;
Radar.AgentReadiness = agent_readiness_1.AgentReadiness;
Radar.AI = ai_1.AI;
Radar.CT = ct_1.CT;
...
Radar.PostQuantum = post_quantum_1.PostQuantum;
...
Radar.Geolocations = geolocations_1.Geolocations;
