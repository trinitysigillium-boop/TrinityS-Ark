...
import * as MitigationsAPI from "./mitigations.js";
import { MitigationListParams, MitigationListResponse, MitigationListResponsesV4PagePagination, MitigationReviewParams, MitigationReviewResponse, MitigationReviewResponsesSinglePage, Mitigations } from "./mitigations.js";
...
export declare class AbuseReports extends APIResource {
    mitigations: MitigationsAPI.Mitigations;
    /**
     * Submit the Abuse Report of a particular type
     */
    create(reportParam: string, params: AbuseReportCreateParams, options?: Core.RequestOptions): Core.APIPromise<AbuseReportCreateResponse>;
    /**
     * List the abuse reports for a given account
     */
    list(params: AbuseReportListParams, options?: Core.RequestOptions): Core.PagePromise<AbuseReportListResponsesV4PagePagination, AbuseReportListResponse>;
    /**
     * Retrieve the details of an abuse report.
     */
    get(reportParam: string, params: AbuseReportGetParams, options?: Core.RequestOptions): Core.APIPromise<AbuseReportGetResponse>;
}
export declare class AbuseReportListResponsesV4PagePagination extends V4PagePagination<AbuseReportListResponse> {
}
/**
...
export declare namespace AbuseReportListResponse {
    interface Report {
        /**
...
export declare namespace AbuseReportGetResponse {
    /**
     * A summary of the mitigations related to this report.
     */
    interface MitigationSummary {
...
export declare namespace AbuseReportCreateParams {
    ...
    interface AbuseReportsTrademarkReport {
        /**
         * Path param: Cloudflare Account ID
         */
        account_id: string;
    ...
    interface AbuseReportsGeneralReport {
        /**
         * Path param: Cloudflare Account ID
         */
        account_id: string;
    ...
    interface AbuseReportsPhishingReport {
        /**
         * Path param: Cloudflare Account ID
         */
        account_id: string;
    ...
    interface AbuseReportsCsamReport {
        /**
         * Path param: Cloudflare Account ID
         */
        account_id: string;
    ...
    interface AbuseReportsThreatReport {
        /**
         * Path param: Cloudflare Account ID
         */
        account_id: string;
    ...
    interface AbuseReportsRegistrarWhoisReport {
        /**
         * Path param: Cloudflare Account ID
         */
        account_id: string;
    ...
    namespace AbuseReportsRegistrarWhoisReport {
        /**
        ...
        interface RegWhoRequest {
             ...
             * all WHOIS requests.
             */
            reg_who_requested_data_elements: Array<'registrant_name' | 'registrant_organization' | 'registrant_email' | 'registrant_phone' | 'registrant_address' | 'registrant_address_country' | 'registrant_address_postal_code' | 'admin_name' | 'admin_organization' | 'admin_email' | 'admin_phone' | 'admin_address' | 'tech_name' | 'tech_organization' | 'tech_email' | 'tech_phone' | 'tech_address'>;
            /**
    ...
    interface AbuseReportsNcseiReport {
        /**
         * Path param: Cloudflare Account ID
         */
        account_id: string;
...
export declare namespace AbuseReports {
    export { type AbuseReportCreateResponse as AbuseReportCreateResponse, type AbuseReportListResponse as AbuseReportListResponse, type AbuseReportGetResponse as AbuseReportGetResponse, AbuseReportListResponsesV4PagePagination as AbuseReportListResponsesV4PagePagination, type AbuseReportCreateParams as AbuseReportCreateParams, type AbuseReportListParams as AbuseReportListParams, type AbuseReportGetParams as AbuseReportGetParams, };
    export { Mitigations as Mitigations, type MitigationListResponse as MitigationListResponse, type MitigationReviewResponse as MitigationReviewResponse, MitigationListResponsesV4PagePagination as MitigationListResponsesV4PagePagination, MitigationReviewResponsesSinglePage as MitigationReviewResponsesSinglePage, type MitigationListParams as MitigationListParams, type MitigationReviewParams as MitigationReviewParams, };
}
