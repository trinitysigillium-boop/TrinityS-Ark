...
import * as ResourcesAPI from "./resources/resources.js";
...
export declare class Managed extends APIResource {
     ...
     * ```
     */
    get(name: string, params: ManagedGetParams, options?: Core.RequestOptions): Core.APIPromise<ManagedGetResponse>;
}
