 ...
 */
export type Configuration = Configuration.HyperdriveInternetOrigin | Configuration.HyperdriveOverAccessOrigin | Configuration.HyperdriveVPCServiceOrigin;
...
export interface Hyperdrive {
     ...
     */
    name: string;
    origin: Hyperdrive.PublicDatabase | Hyperdrive.AccessProtectedDatabaseBehindCloudflareTunnel | Hyperdrive.DatabaseReachableThroughAWorkersVPC;
