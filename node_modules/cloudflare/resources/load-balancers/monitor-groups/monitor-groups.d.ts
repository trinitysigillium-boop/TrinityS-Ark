...
import { ReferenceGetParams, ReferenceGetResponse, ReferenceGetResponsesSinglePage, References } from "./references.js";
import { SinglePage } from "../../../pagination.js";
export declare class MonitorGroups extends APIResource {
     ...
     * ```
     */
    update(monitorGroupId: string, params: MonitorGroupUpdateParams, options?: Core.RequestOptions): Core.APIPromise<MonitorGroup>;
    /**
     ...
     * ```
     */
    list(params: MonitorGroupListParams, options?: Core.RequestOptions): Core.PagePromise<MonitorGroupsSinglePage, MonitorGroup>;
    /**
     ...
     * ```
     */
    delete(monitorGroupId: string, params: MonitorGroupDeleteParams, options?: Core.RequestOptions): Core.APIPromise<MonitorGroup>;
    /**
     ...
     * ```
     */
    edit(monitorGroupId: string, params: MonitorGroupEditParams, options?: Core.RequestOptions): Core.APIPromise<MonitorGroup>;
    /**
     ...
     * ```
     */
    get(monitorGroupId: string, params: MonitorGroupGetParams, options?: Core.RequestOptions): Core.APIPromise<MonitorGroup>;
}
export declare class MonitorGroupsSinglePage extends SinglePage<MonitorGroup> {
}
...
export declare namespace MonitorGroup {
    interface Member {
        /**
...
export declare namespace MonitorGroupCreateParams {
    interface Member {
        /**
         * Whether this monitor is enabled in the group
         */
...
export declare namespace MonitorGroupUpdateParams {
    interface Member {
        /**
         * Whether this monitor is enabled in the group
         */
...
export declare namespace MonitorGroupEditParams {
    interface Member {
        /**
         * Whether this monitor is enabled in the group
         */
