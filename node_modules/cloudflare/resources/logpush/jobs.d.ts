...
export interface LogpushJob {
     ...
     */
    dataset?: 'access_requests' | 'audit_logs' | 'audit_logs_v2' | 'biso_user_actions' | 'casb_findings' | 'device_posture_results' | 'dex_application_tests' | 'dex_device_state_events' | 'dlp_forensic_copies' | 'dns_firewall_logs' | 'dns_logs' | 'email_security_alerts' | 'email_security_post_delivery_events' | 'firewall_events' | 'gateway_dns' | 'gateway_http' | 'gateway_network' | 'http_requests' | 'ipsec_logs' | 'magic_ids_detections' | 'mcp_portal_logs' | 'nel_reports' | 'network_analytics_logs' | 'page_shield_events' | 'sinkhole_http_logs' | 'spectrum_events' | 'ssh_logs' | 'warp_config_changes' | 'warp_toggle_changes' | 'workers_trace_events' | 'zaraz_events' | 'zero_trust_network_sessions' | null;
    /**
