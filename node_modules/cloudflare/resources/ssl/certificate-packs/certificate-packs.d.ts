...
export declare class CertificatePacks extends APIResource {
     ...
     * ```
     */
    list(params: CertificatePackListParams, options?: Core.RequestOptions): Core.PagePromise<CertificatePackListResponsesV4PagePaginationArray, CertificatePackListResponse>;
    /**
...
export declare class CertificatePackListResponsesV4PagePaginationArray extends V4PagePaginationArray<CertificatePackListResponse> {
}
...
export interface CertificatePackCreateResponse {
     ...
     */
    type: 'mh_custom' | 'managed_hostname' | 'sni_custom' | 'universal' | 'advanced' | 'total_tls' | 'keyless' | 'legacy_custom';
    /**
...
export declare namespace CertificatePackCreateResponse {
    /**
...
export declare namespace CertificatePackListResponse {
    /**
     * An individual certificate within a certificate pack.
     */
    interface Certificate {
...
export declare namespace CertificatePackEditResponse {
    /**
     * An individual certificate within a certificate pack.
     */
    interface Certificate {
...
export declare namespace CertificatePackGetResponse {
    /**
     * An individual certificate within a certificate pack.
     */
    interface Certificate {
