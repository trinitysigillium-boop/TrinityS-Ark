...
export declare class Secrets extends APIResource {
     ...
     * ```
     */
    delete(storeId: string, secretId: string, params: SecretDeleteParams, options?: Core.RequestOptions): Core.APIPromise<SecretDeleteResponse | null>;
    /**
     ...
     * ```
     */
    bulkDelete(storeId: string, params: SecretBulkDeleteParams, options?: Core.RequestOptions): Core.APIPromise<SecretBulkDeleteResponse | null>;
    /**
