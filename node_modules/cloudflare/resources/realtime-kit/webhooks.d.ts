...
export declare class Webhooks extends APIResource {
     ...
     * ```
     */
    createWebhook(appId: string, params: WebhookCreateWebhookParams, options?: Core.RequestOptions): Core.APIPromise<WebhookCreateWebhookResponse>;
    /**
     ...
     * ```
     */
    deleteWebhook(appId: string, webhookId: string, params: WebhookDeleteWebhookParams, options?: Core.RequestOptions): Core.APIPromise<WebhookDeleteWebhookResponse>;
    /**
     ...
     * ```
     */
    editWebhook(appId: string, webhookId: string, params: WebhookEditWebhookParams, options?: Core.RequestOptions): Core.APIPromise<WebhookEditWebhookResponse>;
    /**
     ...
     * ```
     */
    getWebhookById(appId: string, webhookId: string, params: WebhookGetWebhookByIDParams, options?: Core.RequestOptions): Core.APIPromise<WebhookGetWebhookByIDResponse>;
    /**
     ...
     * ```
     */
    getWebhooks(appId: string, params: WebhookGetWebhooksParams, options?: Core.RequestOptions): Core.APIPromise<WebhookGetWebhooksResponse>;
    /**
     ...
     * ```
     */
    replaceWebhook(appId: string, webhookId: string, params: WebhookReplaceWebhookParams, options?: Core.RequestOptions): Core.APIPromise<WebhookReplaceWebhookResponse>;
}
export interface WebhookCreateWebhookResponse {
    data: WebhookCreateWebhookResponse.Data;
    success: boolean;
}
export declare namespace WebhookCreateWebhookResponse {
    interface Data {
        /**
         * ID of the webhook
         */
...
export declare namespace WebhookDeleteWebhookResponse {
    interface Data {
        /**
         * ID of the webhook
         */
...
export declare namespace WebhookEditWebhookResponse {
    interface Data {
        /**
         * ID of the webhook
         */
...
export declare namespace WebhookGetWebhookByIDResponse {
    interface Data {
        /**
         * ID of the webhook
         */
...
export declare namespace WebhookGetWebhooksResponse {
    interface Data {
        /**
         * ID of the webhook
         */
...
export declare namespace WebhookReplaceWebhookResponse {
    interface Data {
        /**
         * ID of the webhook
         */
...
export declare namespace Webhooks {
    export { type WebhookCreateWebhookResponse as WebhookCreateWebhookResponse, type WebhookDeleteWebhookResponse as WebhookDeleteWebhookResponse, type WebhookEditWebhookResponse as WebhookEditWebhookResponse, type WebhookGetWebhookByIDResponse as WebhookGetWebhookByIDResponse, type WebhookGetWebhooksResponse as WebhookGetWebhooksResponse, type WebhookReplaceWebhookResponse as WebhookReplaceWebhookResponse, type WebhookCreateWebhookParams as WebhookCreateWebhookParams, type WebhookDeleteWebhookParams as WebhookDeleteWebhookParams, type WebhookEditWebhookParams as WebhookEditWebhookParams, type WebhookGetWebhookByIDParams as WebhookGetWebhookByIDParams, type WebhookGetWebhooksParams as WebhookGetWebhooksParams, type WebhookReplaceWebhookParams as WebhookReplaceWebhookParams, };
}
