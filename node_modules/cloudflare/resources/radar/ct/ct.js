...
const AuthoritiesAPI = __importStar(require("./authorities.js"));
const authorities_1 = require("./authorities.js");
const LogsAPI = __importStar(require("./logs.js"));
const logs_1 = require("./logs.js");
class CT extends resource_1.APIResource {
    constructor() {
        super(...arguments);
...
exports.CT = CT;
CT.Authorities = authorities_1.Authorities;
CT.Logs = logs_1.Logs;
