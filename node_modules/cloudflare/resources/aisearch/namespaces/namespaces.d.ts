...
import { InstanceChatCompletionsParams, InstanceChatCompletionsResponse, InstanceCreateParams, InstanceCreateResponse, InstanceDeleteParams, InstanceDeleteResponse, InstanceListParams, InstanceListResponse, InstanceListResponsesV4PagePaginationArray, InstanceReadParams, InstanceReadResponse, InstanceSearchParams, InstanceSearchResponse, InstanceStatsParams, InstanceStatsResponse, InstanceUpdateParams, InstanceUpdateResponse, Instances } from "./instances/instances.js";
...
export declare class Namespaces extends APIResource {
     ...
     * ```
     */
    update(name: string, params: NamespaceUpdateParams, options?: Core.RequestOptions): Core.APIPromise<NamespaceUpdateResponse>;
    /**
     * List namespaces.
     *
     * @example
     ...
     * ```
     */
    list(params: NamespaceListParams, options?: Core.RequestOptions): Core.PagePromise<NamespaceListResponsesV4PagePaginationArray, NamespaceListResponse>;
    /**
     * Delete namespace.
     *
     * @example
     ...
     * ```
     */
    delete(name: string, params: NamespaceDeleteParams, options?: Core.RequestOptions): Core.APIPromise<NamespaceDeleteResponse>;
    /**
     ...
     * ```
     */
    chatCompletions(name: string, params: NamespaceChatCompletionsParams, options?: Core.RequestOptions): Core.APIPromise<NamespaceChatCompletionsResponse>;
    /**
     * Read namespace.
     *
     * @example
     ...
     * ```
     */
    read(name: string, params: NamespaceReadParams, options?: Core.RequestOptions): Core.APIPromise<NamespaceReadResponse>;
    /**
     ...
     * ```
     */
    search(name: string, params: NamespaceSearchParams, options?: Core.RequestOptions): Core.APIPromise<NamespaceSearchResponse>;
}
export declare class NamespaceListResponsesV4PagePaginationArray extends V4PagePaginationArray<NamespaceListResponse> {
}
...
export declare namespace NamespaceChatCompletionsResponse {
    interface Choice {
...
export declare namespace NamespaceSearchResponse {
    interface Chunk {
        id: string;
        instance_id: string;
        score: number;
...
export declare namespace NamespaceChatCompletionsParams {
...
export declare namespace Namespaces {
    export { type NamespaceCreateResponse as NamespaceCreateResponse, type NamespaceUpdateResponse as NamespaceUpdateResponse, type NamespaceListResponse as NamespaceListResponse, type NamespaceDeleteResponse as NamespaceDeleteResponse, type NamespaceChatCompletionsResponse as NamespaceChatCompletionsResponse, type NamespaceReadResponse as NamespaceReadResponse, type NamespaceSearchResponse as NamespaceSearchResponse, NamespaceListResponsesV4PagePaginationArray as NamespaceListResponsesV4PagePaginationArray, type NamespaceCreateParams as NamespaceCreateParams, type NamespaceUpdateParams as NamespaceUpdateParams, type NamespaceListParams as NamespaceListParams, type NamespaceDeleteParams as NamespaceDeleteParams, type NamespaceChatCompletionsParams as NamespaceChatCompletionsParams, type NamespaceReadParams as NamespaceReadParams, type NamespaceSearchParams as NamespaceSearchParams, };
