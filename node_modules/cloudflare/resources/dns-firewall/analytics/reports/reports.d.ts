...
import * as AnalyticsReportsAPI from "../../../dns/analytics/reports/reports.js";
export declare class Reports extends APIResource {
     ...
     * ```
     */
    get(dnsFirewallId: string, params: ReportGetParams, options?: Core.RequestOptions): Core.APIPromise<AnalyticsReportsAPI.Report>;
}
