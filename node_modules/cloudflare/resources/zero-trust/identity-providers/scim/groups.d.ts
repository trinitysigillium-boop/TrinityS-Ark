...
import { ZeroTrustGroupsV4PagePaginationArray } from "../../access/groups.js";
...
export declare class Groups extends APIResource {
     ...
     * ```
     */
    list(identityProviderId: string, params: GroupListParams, options?: Core.RequestOptions): Core.PagePromise<ZeroTrustGroupsV4PagePaginationArray, GroupsAPI.ZeroTrustGroup>;
}
