...
import { Summary, SummaryCacheHitParams, SummaryCacheHitResponse, SummaryDNSSECAwareParams, SummaryDNSSECAwareResponse, SummaryDNSSECE2EParams, SummaryDNSSECE2EResponse, SummaryDNSSECParams, SummaryDNSSECResponse, SummaryIPVersionParams, SummaryIPVersionResponse, SummaryMatchingAnswerParams, SummaryMatchingAnswerResponse, SummaryProtocolParams, SummaryProtocolResponse, SummaryQueryTypeParams, SummaryQueryTypeResponse, SummaryResponseCodeParams, SummaryResponseCodeResponse, SummaryResponseTTLParams, SummaryResponseTTLResponse } from "./summary.js";
import * as TimeseriesGroupsAPI from "./timeseries-groups.js";
import { TimeseriesGroupCacheHitParams, TimeseriesGroupCacheHitResponse, TimeseriesGroupDNSSECAwareParams, TimeseriesGroupDNSSECAwareResponse, TimeseriesGroupDNSSECE2EParams, TimeseriesGroupDNSSECE2EResponse, TimeseriesGroupDNSSECParams, TimeseriesGroupDNSSECResponse, TimeseriesGroupIPVersionParams, TimeseriesGroupIPVersionResponse, TimeseriesGroupMatchingAnswerParams, TimeseriesGroupMatchingAnswerResponse, TimeseriesGroupProtocolParams, TimeseriesGroupProtocolResponse, TimeseriesGroupQueryTypeParams, TimeseriesGroupQueryTypeResponse, TimeseriesGroupResponseCodeParams, TimeseriesGroupResponseCodeResponse, TimeseriesGroupResponseTTLParams, TimeseriesGroupResponseTTLResponse, TimeseriesGroups } from "./timeseries-groups.js";
...
export declare class DNS extends APIResource {
     ...
     * ```
     */
    summaryV2(dimension: 'AS' | 'CACHE_HIT' | 'DNSSEC' | 'DNSSEC_AWARE' | 'DNSSEC_E2E' | 'IP_VERSION' | 'LOCATION' | 'MATCHING_ANSWER' | 'PROTOCOL' | 'QUERY_TYPE' | 'RESPONSE_CODE' | 'RESPONSE_TTL' | 'TLD' | 'TLD_DNS_MAGNITUDE', query?: DNSSummaryV2Params, options?: Core.RequestOptions): Core.APIPromise<DNSSummaryV2Response>;
    summaryV2(dimension: 'AS' | 'CACHE_HIT' | 'DNSSEC' | 'DNSSEC_AWARE' | 'DNSSEC_E2E' | 'IP_VERSION' | 'LOCATION' | 'MATCHING_ANSWER' | 'PROTOCOL' | 'QUERY_TYPE' | 'RESPONSE_CODE' | 'RESPONSE_TTL' | 'TLD' | 'TLD_DNS_MAGNITUDE', options?: Core.RequestOptions): Core.APIPromise<DNSSummaryV2Response>;
    /**
     ...
     * ```
     */
    timeseriesGroupsV2(dimension: 'AS' | 'CACHE_HIT' | 'DNSSEC' | 'DNSSEC_AWARE' | 'DNSSEC_E2E' | 'IP_VERSION' | 'LOCATION' | 'MATCHING_ANSWER' | 'PROTOCOL' | 'QUERY_TYPE' | 'RESPONSE_CODE' | 'RESPONSE_TTL' | 'TLD' | 'TLD_DNS_MAGNITUDE', query?: DNSTimeseriesGroupsV2Params, options?: Core.RequestOptions): Core.APIPromise<DNSTimeseriesGroupsV2Response>;
    timeseriesGroupsV2(dimension: 'AS' | 'CACHE_HIT' | 'DNSSEC' | 'DNSSEC_AWARE' | 'DNSSEC_E2E' | 'IP_VERSION' | 'LOCATION' | 'MATCHING_ANSWER' | 'PROTOCOL' | 'QUERY_TYPE' | 'RESPONSE_CODE' | 'RESPONSE_TTL' | 'TLD' | 'TLD_DNS_MAGNITUDE', options?: Core.RequestOptions): Core.APIPromise<DNSTimeseriesGroupsV2Response>;
}
...
export declare namespace DNSSummaryV2Response {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export interface DNSTimeseriesResponse {
    ...
    [k: string]: DNSTimeseriesResponse.unnamed_schema_ref_75bae70cf28e6bcef364b9840db3bdeb | DNSTimeseriesResponse.Meta | undefined;
}
export declare namespace DNSTimeseriesResponse {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export declare namespace DNSTimeseriesGroupsV2Response {
    /**
     * Metadata for the results.
     */
    interface Meta {
...
export declare namespace DNS {
    export { type DNSSummaryV2Response as DNSSummaryV2Response, type DNSTimeseriesResponse as DNSTimeseriesResponse, type DNSTimeseriesGroupsV2Response as DNSTimeseriesGroupsV2Response, type DNSSummaryV2Params as DNSSummaryV2Params, type DNSTimeseriesParams as DNSTimeseriesParams, type DNSTimeseriesGroupsV2Params as DNSTimeseriesGroupsV2Params, };
