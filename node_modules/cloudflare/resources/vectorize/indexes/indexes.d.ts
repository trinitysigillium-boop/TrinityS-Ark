...
export declare class Indexes extends APIResource {
     ...
     * ```
     */
    listVectors(indexName: string, params: IndexListVectorsParams, options?: Core.RequestOptions): Core.APIPromise<IndexListVectorsResponse | null>;
    /**
...
export declare namespace IndexListVectorsResponse {
    interface Vector {
        /**
         * Identifier for a Vector
         */
