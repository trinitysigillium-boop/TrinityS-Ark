...
import { JobCreateParams, JobCreateResponse, JobGetParams, JobGetResponse, JobListParams, JobListResponse, JobListResponsesV4PagePaginationArray, JobLogsParams, JobLogsResponse, Jobs } from "./jobs.js";
...
export declare class Instances extends APIResource {
     ...
     * ```
     */
    create(params: InstanceCreateParams, options?: Core.RequestOptions): Core.APIPromise<InstanceCreateResponse>;
    /**
     * Update instance.
     *
     * @example
     ...
     * ```
     */
    update(id: string, params: InstanceUpdateParams, options?: Core.RequestOptions): Core.APIPromise<InstanceUpdateResponse>;
    /**
     * List instances.
     *
     * @example
     ...
     * ```
     */
    list(params: InstanceListParams, options?: Core.RequestOptions): Core.PagePromise<InstanceListResponsesV4PagePaginationArray, InstanceListResponse>;
    /**
     * Delete instance.
     *
     * @example
     ...
     * ```
     */
    delete(id: string, params: InstanceDeleteParams, options?: Core.RequestOptions): Core.APIPromise<InstanceDeleteResponse>;
    /**
     ...
     * ```
     */
    chatCompletions(id: string, params: InstanceChatCompletionsParams, options?: Core.RequestOptions): Core.APIPromise<InstanceChatCompletionsResponse>;
    /**
     * Read instance.
     *
     * @example
     ...
     * ```
     */
    read(id: string, params: InstanceReadParams, options?: Core.RequestOptions): Core.APIPromise<InstanceReadResponse>;
    /**
     ...
     * ```
     */
    search(id: string, params: InstanceSearchParams, options?: Core.RequestOptions): Core.APIPromise<InstanceSearchResponse>;
    /**
     ...
     * ```
     */
    stats(id: string, params: InstanceStatsParams, options?: Core.RequestOptions): Core.APIPromise<InstanceStatsResponse>;
}
...
export declare namespace Instances {
    ...
    export { Jobs as Jobs, type JobCreateResponse as JobCreateResponse, type JobListResponse as JobListResponse, type JobGetResponse as JobGetResponse, type JobLogsResponse as JobLogsResponse, JobListResponsesV4PagePaginationArray as JobListResponsesV4PagePaginationArray, type JobCreateParams as JobCreateParams, type JobListParams as JobListParams, type JobGetParams as JobGetParams, type JobLogsParams as JobLogsParams, };
}
