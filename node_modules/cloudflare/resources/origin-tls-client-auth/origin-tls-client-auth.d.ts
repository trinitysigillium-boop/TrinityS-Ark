...
import * as HostnameCertificatesAPI from "./hostname-certificates.js";
import { Certificate, HostnameCertificateCreateParams, HostnameCertificateCreateResponse, HostnameCertificateDeleteParams, HostnameCertificateDeleteResponse, HostnameCertificateGetParams, HostnameCertificateGetResponse, HostnameCertificateListParams, HostnameCertificateListResponse, HostnameCertificateListResponsesSinglePage, HostnameCertificates } from "./hostname-certificates.js";
import * as HostnamesAPI from "./hostnames.js";
import { AuthenticatedOriginPull, HostnameGetParams, HostnameUpdateParams, HostnameUpdateResponse, HostnameUpdateResponsesSinglePage, Hostnames } from "./hostnames.js";
...
import * as ZoneCertificatesAPI from "./zone-certificates.js";
import { ZoneAuthenticatedOriginPull, ZoneCertificateCreateParams, ZoneCertificateCreateResponse, ZoneCertificateDeleteParams, ZoneCertificateDeleteResponse, ZoneCertificateGetParams, ZoneCertificateGetResponse, ZoneCertificateListParams, ZoneCertificateListResponse, ZoneCertificateListResponsesSinglePage, ZoneCertificates } from "./zone-certificates.js";
import { SinglePage } from "../../pagination.js";
export declare class OriginTLSClientAuth extends APIResource {
    zoneCertificates: ZoneCertificatesAPI.ZoneCertificates;
...
export declare namespace OriginTLSClientAuth {
    export { type OriginTLSClientAuthCreateResponse as OriginTLSClientAuthCreateResponse, type OriginTLSClientAuthListResponse as OriginTLSClientAuthListResponse, type OriginTLSClientAuthDeleteResponse as OriginTLSClientAuthDeleteResponse, type OriginTLSClientAuthGetResponse as OriginTLSClientAuthGetResponse, OriginTLSClientAuthListResponsesSinglePage as OriginTLSClientAuthListResponsesSinglePage, type OriginTLSClientAuthCreateParams as OriginTLSClientAuthCreateParams, type OriginTLSClientAuthListParams as OriginTLSClientAuthListParams, type OriginTLSClientAuthDeleteParams as OriginTLSClientAuthDeleteParams, type OriginTLSClientAuthGetParams as OriginTLSClientAuthGetParams, };
    export { ZoneCertificates as ZoneCertificates, type ZoneAuthenticatedOriginPull as ZoneAuthenticatedOriginPull, type ZoneCertificateCreateResponse as ZoneCertificateCreateResponse, type ZoneCertificateListResponse as ZoneCertificateListResponse, type ZoneCertificateDeleteResponse as ZoneCertificateDeleteResponse, type ZoneCertificateGetResponse as ZoneCertificateGetResponse, ZoneCertificateListResponsesSinglePage as ZoneCertificateListResponsesSinglePage, type ZoneCertificateCreateParams as ZoneCertificateCreateParams, type ZoneCertificateListParams as ZoneCertificateListParams, type ZoneCertificateDeleteParams as ZoneCertificateDeleteParams, type ZoneCertificateGetParams as ZoneCertificateGetParams, };
