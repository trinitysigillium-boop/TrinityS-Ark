...
export declare class TimeTravel extends APIResource {
    /**
     ...
     * ```
     */
    getBookmark(databaseId: string, params: TimeTravelGetBookmarkParams, options?: Core.RequestOptions): Core.APIPromise<TimeTravelGetBookmarkResponse>;
    /**
     ...
     * ```
     */
    restore(databaseId: string, params: TimeTravelRestoreParams, options?: Core.RequestOptions): Core.APIPromise<TimeTravelRestoreResponse>;
}
...
export declare namespace TimeTravel {
    export { type TimeTravelGetBookmarkResponse as TimeTravelGetBookmarkResponse, type TimeTravelRestoreResponse as TimeTravelRestoreResponse, type TimeTravelGetBookmarkParams as TimeTravelGetBookmarkParams, type TimeTravelRestoreParams as TimeTravelRestoreParams, };
}
